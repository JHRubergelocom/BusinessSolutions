 ...
 *       config: {
 *         className: "ssol.pubsec.as.actions.PrepareDocument",
 *         classConfig: {},
 *         method: "getName",
 *         params: []
 *       }
 ...
 */
sol.define("sol.unittest.pubsec.as.services.ExecuteLib1", {
  ...
  process: function () {
    ...
    switch (me.className) {
      case "sol.pubsec.as.functions.CreateFileDeletionReport":
        switch (me.method) {
          case "process":
          case "setReportRights":
            return result;
          default:
        }
        break;
