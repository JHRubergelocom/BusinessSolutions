...
describe("[action] sol.pubsec.as.actions.CreateFileReport", function () {
  var originalTimeout, objTempId, fileTypes, objFPId,
      configAction, wfInfo, checkResult,
      succNodes, succNodesIds,
      repTemplates, repTemplateId, fileId, params, targetId,
      evInfo, dvReport;
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("As.Actions.CreateFileReport", null, null).then(function success(objTempId1) {
  ...
  describe("test create filereport", function () {
    ...
    describe("test create filereport", function () {
      it("get ReportTemplates should not throw", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_pubsec_service_ReportTemplates", { filter: { type: "file" } }).then(function success(repTemplates1) {
      ...
      it("start as action create filereport", function (done) {
        expect(function () {
          repTemplateId = repTemplates[0].objId;
          fileId = objFPId;
          targetId = objTempId;
          params = { templateId: repTemplateId, fileId: fileId, targetId: targetId };
          evInfo = {};
          test.Utils.executeASActionHandler("pubsec", "sol.pubsec.as.actions.CreateFileReport", params, []).then(function success(jsonResults) {
