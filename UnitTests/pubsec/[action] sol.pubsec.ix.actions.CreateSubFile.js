...
describe("[action] sol.pubsec.ix.actions.CreateSubFile", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.CreateSubFile", null, null).then(function success(objTempId1) {
