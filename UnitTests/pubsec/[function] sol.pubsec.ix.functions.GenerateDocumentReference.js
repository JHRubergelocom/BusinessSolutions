...
describe("[function] sol.pubsec.ix.functions.GenerateDocumentReference", function () {
  var originalTimeout, sordDocument, config, documentReference;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.pubsec.ix.functions.generators.GenerateDocumentReference", function () {
      it("getIdentifier", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_pubsec_service_ExecuteLib1", {
            className: "sol.pubsec.ix.functions.generators.GenerateDocumentReference",
            classConfig: {},
