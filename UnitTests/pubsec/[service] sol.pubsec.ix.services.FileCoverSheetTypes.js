...
describe("[service] sol.pubsec.ix.services.FileCoverSheetTypes", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("FileCoverSheetTypes").then(function success(objTempId) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.pubsec.ix.services.CheckFileCoverSheetPreconditions", function () {
      it("initialize", function (done) {
        expect(function () {
          config = {};
          test.Utils.execute("RF_sol_unittest_pubsec_service_ExecuteLib1", {
            className: "sol.pubsec.ix.services.CheckFileCoverSheetPreconditions",
            classConfig: {},
            method: "initialize",
            params: [config]
    ...
    describe("sol.pubsec.ix.services.GetFileCoverSheetTypes", function () {
      it("convert", function (done) {
        expect(function () {
          reportTemplateSords = [];
          test.Utils.execute("RF_sol_unittest_pubsec_service_ExecuteLib1", {
            className: "sol.pubsec.ix.services.GetFileCoverSheetTypes",
            classConfig: {},
            method: "convert",
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_pubsec_service_GetFileCoverSheetTypes", function () {
      it("should not throw if executed without Parameter", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_pubsec_service_GetFileCoverSheetTypes", {
          }).then(function success(jsonResult) {
    ...
    describe("RF_sol_pubsec_service_CheckFileCoverSheetPreconditions", function () {
      it("should throw if executed without Parameter 'targetId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_pubsec_service_CheckFileCoverSheetPreconditions", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
