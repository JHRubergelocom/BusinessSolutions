...
describe("[service] sol.pubsec.ix.services.Directives", function () {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.pubsec.ix.services.CheckDirectivePreconditions", function () {
      it("initialize", function (done) {
        expect(function () {
          config = {};
          test.Utils.execute("RF_sol_unittest_pubsec_service_ExecuteLib1", {
            className: "sol.pubsec.ix.services.CheckDirectivePreconditions",
            classConfig: {},
            method: "initialize",
            params: [config]
    ...
    describe("sol.pubsec.ix.services.GetDirectiveTypes", function () {
      it("convert", function (done) {
        expect(function () {
          directives = [];
          isBound = true;
          test.Utils.execute("RF_sol_unittest_pubsec_service_ExecuteLib1", {
            className: "sol.pubsec.ix.services.GetDirectiveTypes",
            classConfig: {},
            method: "convert",
            params: [directives, isBound]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
            fail(err);
      ...
      it("retrieveAssignedDirectives", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_pubsec_service_ExecuteLib1", {
            className: "sol.pubsec.ix.services.GetDirectiveTypes",
            classConfig: {},
            method: "retrieveAssignedDirectives",
            params: []
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
