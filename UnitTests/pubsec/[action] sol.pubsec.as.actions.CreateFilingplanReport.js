...
describe("[action] sol.pubsec.as.actions.CreateFilingplanReport", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("As.Actions.CreateFilingplanReport", null, null).then(function success(objTempId1) {
  ...
  describe("test create filingplanreport", function () {
    ...
    describe("test create filingplanreport", function () {
      it("get ReportTemplates should not throw", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_pubsec_service_ReportTemplates", { filter: { type: "filingplan" } }).then(function success(repTemplates1) {
      ...
      it("start as action create filingplanreport", function (done) {
        expect(function () {
          ...
          evInfo = {};
          test.Utils.executeASActionHandler("pubsec", "sol.pubsec.as.actions.CreateFilingplanReport", params, []).then(function success(jsonResults) {
