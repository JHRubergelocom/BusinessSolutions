...
describe("[dynkwl] sol.pubsec.ix.dynkwls.FPAllowedFileTypes", function () {
  var originalTimeout, objFPAllowedFileTypesId, kwlConfig;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("FPAllowedFileTypes").then(function success(objFPAllowedFileTypesId1) {
        objFPAllowedFileTypesId = objFPAllowedFileTypesId1;
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.pubsec.ix.dynkwl.FPAllowedFileTypes", function () {
