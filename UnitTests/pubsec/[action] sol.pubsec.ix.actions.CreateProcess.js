...
describe("[action] sol.pubsec.ix.actions.CreateProcess", function () {
  var originalTimeout, objTempId, fileTypes, objFPId,
      ...
      processTypes, n1, processType, config;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.pubsec.ix.actions.CreateProcess", function () {
      it("buildElementName", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_pubsec_service_ExecuteLib1", {
            className: "sol.pubsec.ix.actions.CreateProcess",
            classConfig: {},
