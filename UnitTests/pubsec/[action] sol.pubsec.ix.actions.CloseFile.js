...
describe("[action] sol.pubsec.ix.actions.CloseFile", function () {
  var originalTimeout, objTempId, fileTypes, objFPId,
      ...
      flowId, nameTemplate, config, template;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("Actions.CloseFile", null, null).then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.pubsec.ix.actions.Close", function () {
      ...
      it("getCloseFileNameTemplate", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_pubsec_service_ExecuteLib1", {
            className: "sol.pubsec.ix.actions.Close",
            classConfig: {},
            method: "getCloseFileNameTemplate",
            params: []
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
      ...
      it("getCloseFileWfTemplate", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_pubsec_service_ExecuteLib1", {
            className: "sol.pubsec.ix.actions.Close",
            classConfig: {},
            method: "getCloseFileWfTemplate",
            params: []
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
      ...
      it("getCloseProcessNameTemplate", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_pubsec_service_ExecuteLib1", {
            className: "sol.pubsec.ix.actions.Close",
            classConfig: {},
            method: "getCloseProcessNameTemplate",
            params: []
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
      ...
      it("getCloseProcessWfTemplate", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_pubsec_service_ExecuteLib1", {
            className: "sol.pubsec.ix.actions.Close",
            classConfig: {},
            method: "getCloseProcessWfTemplate",
            params: []
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
      ...
      it("startCloseWorkflow", function (done) {
        expect(function () {
          template = "template1";
          nameTemplate = "nameTemplate1";
          test.Utils.execute("RF_sol_unittest_pubsec_service_ExecuteLib1", {
            className: "sol.pubsec.ix.actions.Close",
            classConfig: {},
            method: "startCloseWorkflow",
            params: [template, nameTemplate]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
            fail(err);
  ...
  describe("test closefile", function () {
    ...
    describe("test finish closefile", function () {
    ...
    describe("test cancel closefile", function () {
      it("check preconditions closefile should not throw", function (done) {
        expect(function () {
