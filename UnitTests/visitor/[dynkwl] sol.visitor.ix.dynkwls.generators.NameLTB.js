...
describe("[dynkwl] sol.visitor.ix.dynkwls.generators.NameFile", function () {
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.visitor.ix.dynkwl.generators.NameFile", function () {
      it("get 'Longterm badge name generators' configuration from kwl.config", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_common_service_GetConfig", {
            ...
            kwlConfig = configResult.config["Longterm badge name generators"];
            done();
          }, function error(err) {
            fail(err);
            console.error(err);
