...
describe("[action] sol.recruiting.ix.actions.CreateCreateLongTermBadge", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.CreateCreateLongTermBadge", null, null).then(function success(objTempId1) {
        interval = 4000;
