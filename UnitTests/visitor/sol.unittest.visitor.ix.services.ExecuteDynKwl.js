...
//@include sol.visitor.ix.localizedKwl.Category.js
//@include sol.visitor.ix.localizedKwl.SecurityClearance.js
//@include sol.visitor.ix.localizedKwl.Status.js
//@include sol.visitor.ix.localizedKwl.StatusVisitorList.js
//@include sol.visitor.ix.localizedKwl.TravelVehicle.js
//@include sol.visitor.ix.localizedKwl.Type.js

var logger = sol.create("sol.Logger", { scope: "sol.unittest.visitor.ix.services.ExecuteDynKwl" });
 ...
 *
 *
 *     sol.common.IxUtils.execute('RF_sol_unittest_visitor_service_ExecuteDynKwl', {
 *       objId: 5201,
 ...
 *
 */
sol.define("sol.unittest.visitor.ix.services.ExecuteDynKwl", {
...
/**
 * @member sol.unittest.visitor.ix.services.ExecuteDynKwl
 * @method RF_sol_unittest_visitor_service_ExecuteDynKwl
 * @static
 * @inheritdoc sol.unittest.ix.ServiceBase#RF_ServiceBaseName
 */
function RF_sol_unittest_visitor_service_ExecuteDynKwl(ec, args) {
  var params, service, result;
  logger.enter("RF_sol_unittest_visitor_service_ExecuteDynKwl", args);
  ...
  params.ec = ec;
  service = sol.create("sol.unittest.visitor.ix.services.ExecuteDynKwl", params);
  result = service.process();
  logger.exit("RF_sol_unittest_visitor_service_ExecuteDynKwl", result);
