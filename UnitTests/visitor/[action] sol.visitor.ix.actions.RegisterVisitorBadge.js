...
describe("[action] sol.visitor.ix.actions.RegisterVisitorBadge", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.RegisterVisitorBadge", null, null).then(function success(objTempId1) {
  ...
  describe("test registervisitorbadge visitor", function () {
    it("should throw if executed without 'user' and 'objId'", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_visitor_action_RegisterVisitorBadge", {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.visitor.ix.actions.RegisterVisitorBadge", function () {
      it("findByIndex", function (done) {
        expect(function () {
          config = {};
          test.Utils.execute("RF_sol_unittest_visitor_service_ExecuteLib1", {
            className: "sol.visitor.ix.actions.RegisterVisitorBadge",
            classConfig: {},
            method: "findByIndex",
            params: [config]
          }).then(function success(jsonResult) {
  ...
  describe("test preregister -> cancel visitor registration -> registervisitorbadge", function () {
    describe("test single visitor", function () {
      ...
      describe("test finish registervisitorbadgevisitor", function () {
        it("get current date, time", function () {
          expect(function () {
            nowDateTime = test.Utils.getNowDateTime();
          }).not.toThrow();
        });
        it("start action registervisitorbadge workflow", function (done) {
          expect(function () {
            config = {
              objId: objIdVs1a
            };
            wfInfo = {};
            test.Utils.executeIxActionHandler("RF_sol_visitor_action_RegisterVisitorBadge", config, []).then(function success(jsonResults) {
              test.Utils.handleAllEvents(jsonResults).then(function success1(wfInfo1) {
                wfInfo = wfInfo1;
                done();
              }, function error(err) {
      ...
      describe("test cancel registervisitorbadgevisitor", function () {
        it("get current date, time", function () {
          expect(function () {
            nowDateTime = test.Utils.getNowDateTime();
          }).not.toThrow();
    ...
    describe("test group", function () {
      ...
      describe("test cancel registervisitorbadgegroup", function () {
        it("get current date, time", function () {
          expect(function () {
            nowDateTime = test.Utils.getNowDateTime();
          }).not.toThrow();
      ...
      describe("test finish registervisitorbadgegroup", function () {
        it("get current date, time", function () {
          expect(function () {
            nowDateTime = test.Utils.getNowDateTime();
          }).not.toThrow();
