...
describe("[action] sol.visitor.ix.actions.PreRegisterGroup", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.PreRegisterGroup", null, null).then(function success(objTempId1) {
  ...
  describe("test preregister group", function () {
    it("should throw if executed without 'user' and 'visitorType'", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_visitor_action_PreRegisterGroup", {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.visitor.ix.actions.PreRegisterGroup", function () {
      it("buildElementName", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_visitor_service_ExecuteLib1", {
            className: "sol.visitor.ix.actions.PreRegisterGroup",
            classConfig: {},
  ...
  describe("test finish preregistergroup", function () {
  ...
  describe("test cancel preregistergroup", function () {
    it("get current date, time", function () {
      expect(function () {
        nowDateTime = test.Utils.getNowDateTime();
      }).not.toThrow();
