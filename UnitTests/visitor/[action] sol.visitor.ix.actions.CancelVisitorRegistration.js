...
describe("[action] sol.visitor.ix.actions.CancelVisitorRegistration", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.CancelVisitorRegistration", null, null).then(function success(objTempId1) {
  ...
  describe("test cancel visitor registration", function () {
    it("should throw if executed without 'user' and 'visitorObjId'", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_visitor_action_CancelVisitorRegistration", {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.visitor.ix.actions.CancelVisitorRegistration", function () {
      it("getName", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_visitor_service_ExecuteLib1", {
            className: "sol.visitor.ix.actions.CancelVisitorRegistration",
            classConfig: {},
            method: "getName",
            params: []
          }).then(function success(jsonResult) {
  ...
  describe("test single visitor", function () {
    ...
    describe("test finish cancelvisitorregistration", function () {
      it("start action cancel workflow", function (done) {
        expect(function () {
          config = {
            visitorObjId: objIdVs1
          };
          wfInfo = {};
          test.Utils.executeIxActionHandler("RF_sol_visitor_action_CancelVisitorRegistration", config, []).then(function success(jsonResults) {
            test.Utils.handleAllEvents(jsonResults).then(function success1(wfInfo1) {
              wfInfo = wfInfo1;
              done();
            }, function error(err) {
      ...
      it("set cancel reason in visitor sord", function (done) {
        expect(function () {
          test.Utils.getSord(objIdVs1).then(function success(sordVs1) {
            keywording = {
              VISITOR_CANCEL_REASON: "Kein Bedarf"
            };
            test.Utils.updateKeywording(sordVs1, keywording, true).then(function success1(updateKeywordingResult) {
              done();
            }, function error(err) {
    ...
    describe("test cancel cancelvisitorregistration", function () {
      it("start action cancel workflow", function (done) {
        expect(function () {
          config = {
  ...
  describe("test group", function () {
    ...
    describe("test cancel cancelvisitorregistration", function () {
      ...
      it("set cancel reason date group sord", function (done) {
        expect(function () {
          test.Utils.getSord(objIdGr1).then(function success(sordGr1) {
            keywording = {
              VISITOR_CANCEL_REASON: "Krank"
            };
            test.Utils.updateKeywording(sordGr1, keywording, true).then(function success1(updateKeywordingResult) {
              done();
            }, function error(err) {
      ...
      it("remove workflows", function (done) {
        expect(function () {
          test.Utils.getFinishedWorkflows(objIdGr1).then(function success(wfs) {
            test.Utils.removeFinishedWorkflows(wfs).then(function success1(removeFinishedWorkflowsResult) {
              done();
            }, function error(err) {
              fail(err);
    ...
    describe("test finish cancelvisitorregistration", function () {
      ...
      it("set cancel reason group sord", function (done) {
        expect(function () {
          test.Utils.getSord(objIdGr2).then(function success(sordGr2) {
            keywording = {
              VISITOR_CANCEL_REASON: "Kein Platz"
            };
            test.Utils.updateKeywording(sordGr2, keywording, true).then(function success1(updateKeywordingResult) {
              done();
            }, function error(err) {
      ...
      it("remove workflows", function (done) {
        expect(function () {
          test.Utils.getFinishedWorkflows(objIdGr2).then(function success(wfs) {
            test.Utils.removeFinishedWorkflows(wfs).then(function success1(removeFinishedWorkflowsResult) {
              done();
            }, function error(err) {
              fail(err);
