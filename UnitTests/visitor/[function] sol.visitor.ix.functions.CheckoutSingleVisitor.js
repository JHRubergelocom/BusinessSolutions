...
describe("[function] sol.visitor.ix.functions.CheckoutSingleVisitor", function () {
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_visitor_function_CheckoutSingleVisitor", function () {
      ...
      describe("checkout single visitor", function () {
        it("checkout single visitor ", function (done) {
          expect(function () {
            test.Utils.execute("RF_sol_visitor_function_CheckoutSingleVisitor", {
      ...
      describe("checkout single visitor in group", function () {
        ...
        it("checkout single visitor1 in group sord", function (done) {
          expect(function () {
