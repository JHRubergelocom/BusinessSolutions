...
describe("[action] sol.visitor.ix.actions.CheckInVisitor", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.CheckInVisitor", null, null).then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.visitor.ix.actions.CheckInVisitor", function () {
      it("checkVisitorPreconditions", function (done) {
        expect(function () {
          visitorSord = { id: objTempId };
          test.Utils.execute("RF_sol_unittest_visitor_service_ExecuteLib1", {
            className: "sol.visitor.ix.actions.CheckInVisitor",
            classConfig: {},
            method: "checkVisitorPreconditions",
            params: [visitorSord]
  ...
  describe("test checkin visitor", function () {
    it("should throw if executed without 'user' and 'visitorObjId'", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_visitor_action_CheckInVisitor", {
        }).then(function success(jsonResult) {
          fail(jsonResult);
          done();
        }, function error(err) {
  ...
  describe("test single visitor", function () {
    ...
    describe("test finish checkinvisitor", function () {
      it("get current date, time", function () {
        expect(function () {
          nowDateTime = test.Utils.getNowDateTime();
        }).not.toThrow();
    ...
    describe("test cancel checkinvisitor", function () {
      it("get current date, time", function () {
        expect(function () {
          nowDateTime = test.Utils.getNowDateTime();
        }).not.toThrow();
  ...
  describe("test group", function () {
    ...
    describe("test cancel checkingroup", function () {
      it("get current date, time", function () {
        expect(function () {
          nowDateTime = test.Utils.getNowDateTime();
        }).not.toThrow();
    ...
    describe("test finish checkingroup", function () {
      it("get current date, time", function () {
        expect(function () {
          nowDateTime = test.Utils.getNowDateTime();
        }).not.toThrow();
