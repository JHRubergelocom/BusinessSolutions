...
describe("[function] sol.visitor.ix.functions.GenerateVisitorGroupName", function () {
  var originalTimeout, sordVisitorGroup, config, n1;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.visitor.ix.functions.generators.GenerateVisitorGroupName", function () {
      it("getIdentifier", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_visitor_service_ExecuteLib1", {
            className: "sol.visitor.ix.functions.generators.GenerateVisitorGroupName",
            classConfig: {},
