...
describe("[dynkwl] sol.invoice.ix.dynkwls.SpecialGlIndicator", function () {
  var originalTimeout, objSpecialGlIndicatorId, kwlConfig;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("SpecialGlIndicator").then(function success(objSpecialGlIndicatorId1) {
        objSpecialGlIndicatorId = objSpecialGlIndicatorId1;
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.invoice.ix.dynkwl.SpecialGlIndicator", function () {
      it("get 'Special Gl indicators' configuration from kwl.config", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_common_service_GetConfig", {
            ...
            kwlConfig = configResult.config["Special Gl indicators"];
