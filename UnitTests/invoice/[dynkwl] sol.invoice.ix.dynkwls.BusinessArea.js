...
describe("[dynkwl] sol.invoice.ix.dynkwls.BusinessArea", function () {
  var originalTimeout, objBusinessAreaId, kwlConfig;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("BusinessArea").then(function success(objBusinessAreaId1) {
        objBusinessAreaId = objBusinessAreaId1;
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.invoice.ix.dynkwl.BusinessArea", function () {
      it("get 'Business areas' configuration from kwl.config", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_common_service_GetConfig", {
            ...
            kwlConfig = configResult.config["Business areas"];
