...
describe("[action] sol.invoice.LoadInvoiceTemplate", function () {
  var invoiceMask, invoiceConfig,
      ...
      templateRootFolder, srcTemplateId,
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.LoadInvoiceTemplate", null, null).then(function success(objTempId) {
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("test load invoice template", function () {
    it("create invoice template", function (done) {
      expect(function () {
        ...
        }).then(function success1(srcTemplateId1) {
          srcTemplateId = srcTemplateId1;
          done();
        }, function error(err) {
          fail(err);
          console.error(err);
    ...
    expect(function () {
      test.Utils.getTempfolder().then(function success(tempfolder) {
        test.Utils.deleteSord(tempfolder).then(function success1(deleteResult) {
          test.Utils.deleteSord(srcTemplateId).then(function success2(deleteResult1) {
            done();
          }, function error(err) {
            fail(err);
            console.error(err);
