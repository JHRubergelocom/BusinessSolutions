...
describe("[dynkwl] sol.invoice.ix.dynkwls.TaxCode", function () {
  var originalTimeout, objTaxCodeId, kwlConfig;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("TaxCode").then(function success(objTaxCodeId1) {
        objTaxCodeId = objTaxCodeId1;
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.invoice.ix.dynkwl.TaxCode", function () {
      it("get 'Tax codes' configuration from kwl.config", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_common_service_GetConfig", {
            ...
            kwlConfig = configResult.config["Tax codes"];
