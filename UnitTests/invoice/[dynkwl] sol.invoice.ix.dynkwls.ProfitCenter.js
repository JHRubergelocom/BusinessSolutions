...
describe("[dynkwl] sol.invoice.ix.dynkwls.ProfitCenter", function () {
  var originalTimeout, objProfitCenterId, kwlConfig;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("ProfitCenter").then(function success(objProfitCenterId1) {
        objProfitCenterId = objProfitCenterId1;
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.invoice.ix.dynkwl.ProfitCenter", function () {
      it("get 'Profit centers' configuration from kwl.config", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_common_service_GetConfig", {
            ...
            kwlConfig = configResult.config["Profit centers"];
