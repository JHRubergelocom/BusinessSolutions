...
describe("[action] sol.invoice.ZugferdIncomingInvoice2", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.ZugferdIncomingInvoice2", null, null).then(function success(objTempId) {
        interval = 4000;
        done();
      }, function error(err) {
        fail(err);
  ...
  describe("test incoming invoice -> 'Forward for approval' -> 'Reject Cost Object' -> 'Back to approval' -> 'Approve Cost Object' -> 'Forward to ERP'", function () {
