...
describe("[function] sol.invoice.ix.functions.InvoiceUserStart", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("InvoiceUserStart", null, null).then(function success(objInvoiceUserStartId) {
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("Test Lib Functions", function () {
    describe("sol.invoice.ix.functions.InvoiceUserStart", function () {
