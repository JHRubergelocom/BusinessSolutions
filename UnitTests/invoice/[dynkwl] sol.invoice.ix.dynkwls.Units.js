...
describe("[dynkwl] sol.invoice.ix.dynkwls.Units", function () {
  var originalTimeout, objUnitsId, kwlConfig;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("Units").then(function success(objUnitsId1) {
        objUnitsId = objUnitsId1;
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.invoice.ix.dynkwl.Units", function () {
      it("get 'Units' configuration from kwl.config", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_common_service_GetConfig", {
            ...
            kwlConfig = configResult.config["Units"];
            kwlConfig.searchParams = ["DE", "C", "C", "C"];
            done();
          }, function error(err) {
            fail(err);
            console.error(err);
