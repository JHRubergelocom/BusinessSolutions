...
describe("[libix] sol.unittest.ix.services.SolInvoiceLineApprovalMixin", function () {
  var originalTimeout, currentValue, condition, conditions, value, lineNo, text, objId, flowId, rule, wfMap, approvalId, approver;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.invoice.ix.LineApprovalMixin", function () {
      ...
      xit("getMaxApprovalId", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_invoice_service_ExecuteLib", {
            className: "sol.invoice.ix.LineApprovalMixin",
            classConfig: {objId: 1 },
      ...
      xit("logInvoiceData", function (done) {
        expect(function () {
          text = PVALUE;
          objId = PVALUE;
          flowId = PVALUE;
      ...
      xit("setApprovalIds", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_invoice_service_ExecuteLib", {
            className: "sol.invoice.ix.LineApprovalMixin",
            classConfig: {},
      ...
      xit("setLineApproved", function (done) {
        expect(function () {
          wfMap = PVALUE;
          approvalId = PVALUE;
          approver = PVALUE;
