...
describe("[action] sol.invoice.IncomingInvoice3", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.IncomingInvoice3", null, null).then(function success(objTempId) {
        interval = 4000;
        done();
      }, function error(err) {
        fail(err);
  ...
  describe("test incoming invoice -> 'Forward for approval' -> 'Approve Cost Object' -> 'Forward to clearing' -> 'Reject'", function () {
