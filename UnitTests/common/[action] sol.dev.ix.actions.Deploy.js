...
describe("[action] sol.dev.ix.actions.Deploy", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.Deploy", null, null).then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.dev.ix.actions.Deploy", function () {
      it("buildElementName", function (done) {
        expect(function () {
          mode = "deploy";
          test.Utils.execute("RF_sol_unittest_service_ExecuteLib7", {
            className: "sol.dev.ix.actions.Deploy",
            classConfig: { ci: {}, user: {}, objId: objTempId, mode: "deploy" },
