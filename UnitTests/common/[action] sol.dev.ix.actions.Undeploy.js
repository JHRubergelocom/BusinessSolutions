...
describe("[action] sol.dev.ix.actions.Undeploy", function () {
  var packageTypes,
      configAction, wfInfo,
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.Undeploy", null, null).then(function success(objTempId) {
        interval = 4000;
        done();
      }, function error(err) {
        fail(err);
  ...
  describe("test deploy/undeploy", function () {
    it("should throw if executed without parameter 'objId'", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_dev_action_Deploy", {
    ...
    it("should throw if executed without parameter 'mode'", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_dev_action_Deploy", {
          objId: objPackageId
        }).then(function success(jsonResult) {
    ...
    describe("test cancel deploy", function () {
      it("start action create workflow", function (done) {
        expect(function () {
          configAction = {
            objId: objPackageId,
          ...
          wfInfo = {};
          test.Utils.executeIxActionHandler("RF_sol_dev_action_Deploy", configAction, []).then(function success(jsonResults) {
            test.Utils.handleAllEvents(jsonResults).then(function success1(wfInfo1) {
              wfInfo = wfInfo1;
              done();
            }, function error(err) {
    ...
    describe("test cancel undeploy", function () {
      it("start action create workflow", function (done) {
        expect(function () {
          configAction = {
            objId: objPackageId,
    ...
    describe("test finish deploy", function () {
      it("start action create workflow", function (done) {
        expect(function () {
          configAction = {
            objId: objPackageId,
    ...
    describe("test finish undeploy", function () {
      it("start action create workflow", function (done) {
        expect(function () {
          configAction = {
            objId: objPackageId,
