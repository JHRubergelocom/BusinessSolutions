...
describe("[libix] sol.unittest.ix.services.SolCommonServiceBase", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("SolCommonServiceBase").then(function success(obSolCommonServiceBaseId1) {
        obSolCommonServiceBaseId = obSolCommonServiceBaseId1;
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("Test Lib Functions", function () {
    describe("sol.common.ix.ServiceBase", function () {
      it("checkMandatoryProperties", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_service_ExecuteLib2", {
            className: "sol.unittest.ix.ServiceBase",
            classConfig: {},
            method: "checkMandatoryProperties",
            params: []
      ...
      it("prefillMetadata", function (done) {
        expect(function () {
          objId = obSolCommonServiceBaseId;
          test.Utils.execute("RF_sol_unittest_service_ExecuteLib2", {
            className: "sol.unittest.ix.ServiceBase",
            classConfig: {},
            method: "prefillMetadata",
            params: [objId]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
