...
describe("[function] sol.dev.as.functions.InstallTest", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("InstallTest").then(function success(objExportId) {
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("Tests AS Action", function () {
    describe("sol.dev.InstallTest", function () {
