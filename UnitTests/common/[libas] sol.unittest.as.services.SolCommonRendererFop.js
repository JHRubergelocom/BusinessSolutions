...
describe("[libas] sol.unittest.as.services.SolCommonRendererFop", function () {
  var RendererFopSord, obSolCommonRendererFopId, originalTimeout, content, config, name, data;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.common.as.renderer.Fop", function () {
      it("initialize", function (done) {
        expect(function () {
          ...
          test.Utils.execute("RF_sol_common_service_ExecuteAsAction", {
            ...
            config: {
              className: "sol.common.as.renderer.Fop",
              classConfig: { targetId: obSolCommonRendererFopId, templateId: RendererFopSord.id },
              method: "initialize",
              params: [config]
            }
