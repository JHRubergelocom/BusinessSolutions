...
describe("[function] sol.common.ix.functions.Subscription", function () {
  var originalTimeout, objSubscriptionId, config;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.common.ix.functions.Subscription", function () {
      it("initialize", function (done) {
        expect(function () {
          config = {};
          test.Utils.execute("RF_sol_unittest_service_ExecuteLib8", {
            className: "sol.common.ix.functions.Subscription",
            classConfig: { objId: objSubscriptionId },
            method: "initialize",
            params: [config]
