...
describe("[function] sol.common.ix.functions.CheckSolutionEnabled", function () {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.common.ix.functions.CheckSolutionEnabled", function () {
      it("checkSolutionEnabled", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_service_ExecuteLib8", {
            className: "sol.common.ix.functions.CheckSolutionEnabled",
            classConfig: { solution: "common" },
            method: "checkSolutionEnabled",
            params: []
