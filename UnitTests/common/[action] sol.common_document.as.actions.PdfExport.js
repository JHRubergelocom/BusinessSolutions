...
describe("[action] sol.common_document.as.actions.PdfExport", function () {
  var originalTimeout, content, PdfExportSord;
      ...
      it("should not throw with empty config", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_common_service_ExecuteAsAction", {
            action: "sol.common_document.as.actions.PdfExport",
            config: {}
