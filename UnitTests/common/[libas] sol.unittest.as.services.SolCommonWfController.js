...
describe("[libas] sol.unittest.as.services.SolCommonWfController", function () {
  var originalTimeout, content, value, nodeConfig, resultObj, waitDef, params, ex,
      errorUserConfig, workflow, nodeId;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.common.as.WfController", function () {
      it("calculateErrorUser", function (done) {
        expect(function () {
          errorUserConfig = {};
          test.Utils.execute("RF_sol_common_service_ExecuteAsAction", {
            ...
            config: {
              ...
              classConfig: {},
              method: "calculateErrorUser",
              params: [errorUserConfig]
            }
      ...
      it("calculatePreviousUser", function (done) {
        expect(function () {
          workflow = {};
          nodeId = 2;
          test.Utils.execute("RF_sol_common_service_ExecuteAsAction", {
