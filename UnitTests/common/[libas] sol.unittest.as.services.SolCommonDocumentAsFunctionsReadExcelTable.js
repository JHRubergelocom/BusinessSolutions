...
describe("[libas] sol.unittest.as.services.SolCommonDocumentAsFunctionsReadExcelTable", function () {
  var AsFunctionsReadExcelTableSord, originalTimeout, objId, tableConfig, content;
      ...
      it("process", function (done) {
        expect(function () {
          ...
          test.Utils.execute("RF_sol_common_service_ExecuteAsAction", {
            ...
            config: {
              className: "sol.common_document.as.functions.ReadExcelTable",
              classConfig: { objId: objId, tableConfig: tableConfig },
              method: "process",
              params: []
            }
          }).then(function success(jsonResult) {
