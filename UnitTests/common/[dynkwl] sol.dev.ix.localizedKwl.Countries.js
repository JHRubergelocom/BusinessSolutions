...
describe("[dynkwl] sol.dev.ix.localizedKwl.Countries", function () {
  var originalTimeout, objCountriesId, config;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.dev.ix.localizedKwl.Countries", function () {
      it("initialize", function (done) {
        expect(function () {
          config = {};
          test.Utils.execute("RF_sol_unittest_service_ExecuteLib7", {
            className: "sol.dev.ix.localizedKwl.Countries",
            classConfig: {},
            method: "initialize",
            params: [config]
    ...
    describe("sol.dev.ix.localizedKwl.Countries", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_service_ExecuteDynKwl", {
            objId: objCountriesId,
            dynKwl: "sol.dev.ix.localizedKwl.Countries"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
