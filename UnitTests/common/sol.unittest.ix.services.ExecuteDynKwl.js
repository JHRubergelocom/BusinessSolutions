...
//@include lib_sol.unittest.ix.dynkwl.UserNames.js
//@include sol.common_monitoring.ix.dynkwl.ConfigKwl.js
//@include sol.dev.ix.localizedKwl.Countries.js

var logger = sol.create("sol.Logger", { scope: "sol.unittest.ix.services.ExecuteDynKwl" });
 ...
 *
 *
 *     sol.common.IxUtils.execute('RF_sol_unittest_service_ExecuteDynKwl', {
 *       objId: 5201,
 ...
 *
 */
sol.define("sol.unittest.ix.services.ExecuteDynKwl", {
...
/**
 * @member sol.unittest.ix.services.ExecuteDynKwl
 * @method RF_sol_unittest_service_ExecuteDynKwl
 * @static
 * @inheritdoc sol.unittest.ix.ServiceBase#RF_ServiceBaseName
 */
function RF_sol_unittest_service_ExecuteDynKwl(ec, args) {
  var params, service, result;
  logger.enter("RF_sol_unittest_service_ExecuteDynKwl", args);
  ...
  params.ec = ec;
  service = sol.create("sol.unittest.ix.services.ExecuteDynKwl", params);
  result = service.process();
  logger.exit("RF_sol_unittest_service_ExecuteDynKwl", result);
