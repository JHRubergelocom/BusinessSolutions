...
describe("[action] sol.dev.ix.actions.CreatePackage", function () {
  var originalTimeout, objTempId, packageTypes,
      configAction, wfInfo, packageType, config,
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.CreatePackage", null, null).then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.dev.ix.actions.CreatePackage", function () {
      it("buildElementName", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_service_ExecuteLib7", {
            className: "sol.dev.ix.actions.CreatePackage",
            classConfig: { ci: {}, user: {}, templateId: objTempId, packageType: "packageType1" },
