...
describe("[action] sol.dev.ix.actions.CreatePackage", function () {
  var originalTimeout, packageTypes,
      configAction, wfInfo,
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.CreatePackage", null, null).then(function success(objTempId) {
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  it("packageTypes must be available", function () {
    expect(packageTypes).toBeDefined();
  });
  it("packageTypes.length must greater than zero", function () {
    expect(packageTypes.length).toBeGreaterThan(0);
  });
  it("should throw if executed without parameter 'packageType'", function (done) {
    expect(function () {
      test.Utils.execute("RF_sol_dev_action_CreatePackage", {
  ...
  describe("test finish createpackage", function () {
  ...
  describe("test cancel createpackage", function () {
    it("start action create workflow", function (done) {
      expect(function () {
        configAction = {
          packageType: packageTypes[0].name,
    ...
    expect(function () {
      test.Utils.getTempfolder().then(function success(tempfolder) {
        test.Utils.deleteSord(tempfolder).then(function success1(deleteResult) {
          test.Utils.deleteSord("ARCPATH[(E10E1000-E100-E100-E100-E10E10E10E00)]:/Business Solutions/unittest").then(function success2(deleteResult1) {
            test.Utils.deleteSord("ARCPATH[(E10E1000-E100-E100-E100-E10E10E10E00)]:/Business Solutions Custom/unittest").then(function success3(deleteResult2) {
              done();
            }, function error(err) {
              console.error(err);
              done();
