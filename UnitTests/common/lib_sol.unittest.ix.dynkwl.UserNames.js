...
/**
 * @class sol.unittest.ix.dynkwl.UserNames
 *
 ...
 */
sol.define("sol.unittest.ix.dynkwl.UserNames", {
 ...
 * @static
 * @member sol.unittest.ix.dynkwl.UserNames
...
function getDataIterator() {
  ...
  try {
    ...
    iterator = sol.create("sol.unittest.ix.dynkwl.UserNames", {});
