...
describe("[function] sol.dev.ix.functions.Deploy", function () {
  var packageTypes,
      ...
      originalTimeout, interval, config, objTempTId;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.dev.ix.functions.Deploy", function () {
      ...
      it("getInstallConfig", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_service_ExecuteLib8", {
            className: "sol.dev.ix.functions.Deploy",
