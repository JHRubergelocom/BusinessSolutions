...
describe("[function] sol.common_document.ix.functions.EditWordParts", function () {
  var originalTimeout, config, objEditWordPartsId;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("EditWordParts").then(function success(obEditWordPartsId) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.common_document.ix.functions.EditWordParts", function () {
      it("initialize", function (done) {
        expect(function () {
          config = {};
          test.Utils.execute("RF_sol_unittest_service_ExecuteLib8", {
            className: "sol.common_document.ix.functions.EditWordParts",
            classConfig: { objId: objEditWordPartsId },
            method: "initialize",
            params: [config]
