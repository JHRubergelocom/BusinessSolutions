...
describe("[libas] sol.unittest.as.services.SolCommonDocumentUtils", function () {
  var originalTimeout, content, outputStream, sord, folderName,
      ...
      feedUrl, dstFeedPdfPath, jsonObject, noteRGB, setAlpha, page, pWidth, pHeight,
      pdfDocument, note, repoPath, textWatermark, dstFile;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.common_document.as.Utils", function () {
      it("_convertHtmlFileToPdf", function (done) {
        expect(function () {
          filePath = "filePath1";
      ...
      it("_convertHtmlToPdf", function (done) {
        expect(function () {
      ...
      it("appendFeedInfo", function (done) {
        expect(function () {
          sord = obSolCommonDocumentUtilsId;
          dstDirPath = "dstDirPath1";
          pdfName = "pdfName1";
          ...
          test.Utils.execute("RF_sol_common_service_ExecuteAsAction", {
            ...
            config: {
              className: "sol.common_document.as.Utils",
              classConfig: {},
              method: "appendFeedInfo",
              params: [sord, dstDirPath, pdfName, config]
            }
          }).then(function success(jsonResult) {
            content = jsonResult.content;
            if (content.indexOf("exception") != -1) {
      ...
      it("convertFeedToPdf", function (done) {
        expect(function () {
          feedUrl = "feedUrl1";
          dstFeedPdfPath = "dstFeedPdfPath1";
          test.Utils.execute("RF_sol_common_service_ExecuteAsAction", {
            action: "sol.unittest.as.services.ExecuteLib2",
            config: {
              className: "sol.common_document.as.Utils",
              classConfig: {},
              method: "convertFeedToPdf",
              params: [feedUrl, dstFeedPdfPath]
            }
          }).then(function success(jsonResult) {
            content = jsonResult.content;
            if (content.indexOf("exception") != -1) {
      ...
      it("getWkhtmltopdfPath", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_common_service_ExecuteAsAction", {
            action: "sol.unittest.as.services.ExecuteLib2",
            config: {
