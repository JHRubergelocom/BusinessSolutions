...
describe("[function] sol.common.ix.functions.CheckDynAdHocFlowStart", function () {
  var originalTimeout, config, objCheckDynAdHocFlowStartId,
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("CheckDynAdHocFlowStart").then(function success(objCheckDynAdHocFlowStartId1) {
        objCheckDynAdHocFlowStartId = objCheckDynAdHocFlowStartId1;
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("Test Lib Functions", function () {
    describe("sol.common.ix.functions.CheckDynAdHocFlowStart", function () {
      it("start Workflow Unittest", function (done) {
        expect(function () {
          test.Utils.startWorkflow("Unittest", "Workflow Unittest", objCheckDynAdHocFlowStartId).then(function success(flowId1) {
            flowId = flowId1;
            done();
          }, function error(err) {
            fail(err);
      ...
      it("initialize", function (done) {
        expect(function () {
          config = { wfDiagram: workflow };
          test.Utils.execute("RF_sol_unittest_service_ExecuteLib8", {
            className: "sol.common.ix.functions.CheckDynAdHocFlowStart",
