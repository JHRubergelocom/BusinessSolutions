...
describe("[action] sol.meeting.ix.actions.FinalizeAgenda", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("FinalizeAgenda").then(function success(objTempId) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.actions.FinalizeAgenda", function () {
      it("getMeeting", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.actions.FinalizeAgenda",
            classConfig: { id: objMeetingId },
            method: "getMeeting",
            params: []
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_action_FinalizeAgenda", function () {
      it("should throw if executed without 'id' ", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_action_FinalizeAgenda", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
