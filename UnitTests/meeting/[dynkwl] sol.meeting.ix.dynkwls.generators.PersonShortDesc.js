...
describe("[dynkwl] sol.meeting.ix.dynkwls.generators.PersonShortDesc", function () {
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.meeting.ix.dynkwl.generators.meeting", function () {
      it("get 'personShortDesc' configuration from kwl.config", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_common_service_GetConfig", {
            ...
            kwlConfig = configResult.config["personShortDesc"];
            done();
          }, function error(err) {
            fail(err);
            console.error(err);
