...
describe("[action] sol.meeting.ix.actions.StartMeeting", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("StartMeeting").then(function success(objTempId) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.actions.StartMeeting", function () {
      it("getMeeting", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.actions.StartMeeting",
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_action_StartMeeting", function () {
      it("should throw if executed without 'id' ", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_action_StartMeeting", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
