...
describe("[service] sol.meeting.ix.services.MeetingFilePrecondition", function () {
  var originalTimeout, objTempId, meetingBoardTypes, configTypes, configAction,
      wfInfo, succNodes, succNodesIds, objIdMB, objIdM, meetingItemTypes,
      msg;
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("MeetingFilePrecondition").then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting_premium.services.MeetingFilePrecondition", function () {
      it("checkForWithdrawnItems", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting_premium.services.MeetingFilePrecondition",
            classConfig: { targetId: objIdM },
            method: "checkForWithdrawnItems",
            params: []
      ...
      it("checkProposals", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting_premium.services.MeetingFilePrecondition",
            classConfig: { targetId: objIdM },
            method: "checkProposals",
            params: []
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
      ...
      it("failedPrecondition", function (done) {
        expect(function () {
          msg = "Failed precondition function";
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting_premium.services.MeetingFilePrecondition",
            classConfig: { targetId: objIdM },
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_premium_service_MeetingFilePrecondition", function () {
      it("should throw if executed without Parameter 'targetId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_premium_service_MeetingFilePrecondition", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("create withdraw precondition", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_premium_service_MeetingFilePrecondition", {
            targetId: objIdM
          }).then(function success(jsonResult) {
