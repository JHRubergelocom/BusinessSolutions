...
/*
  describe("create meeting", function () {
    it("meetingTypes must be available", function (done) {
      configTypes = {
        $types: {
          path: "ARCPATH[(E10E1000-E100-E100-E100-E10E10E10E00)]:/Business Solutions/meeting/Configuration/Long term badge types"
        }
      };
      test.Utils.execute("RF_sol_common_service_StandardTypes", configTypes).then(function success(meetingTypes1) {
      ...
      expect(function () {
        configAction = {
          ...
          $new: {
            ...
            template: {
              base: "ARCPATH[(E10E1000-E100-E100-E100-E10E10E10E00)]:/Business Solutions/meeting/Configuration/Long term badge types",
          ...
          $wf: {
            template: {
              name: "sol.meeting.meeting.create"
            },
            name: "{{translate 'sol.meeting.workflow.meeting.create.name'}}"
          },
          $metadata: {
            owner: {
              fromConnection: true
    ...
    it("fill meeting sord", function (done) {
      expect(function () {
        test.Utils.getSord(wfInfo.objId).then(function success(sordL1) {
          ...
          test.Utils.updateKeywording(sordL1, { MEETING_FIRSTNAME: "Bernd", MEETING_LASTNAME: "Stromberg" }, true).then(function success1(updateKeywordingResult) {
            done();
          }, function error(err) {
            fail(err);
            console.error(err);
  ...
  */
  ...
  describe("test finish createmeeting", function () {
    it("start action create workflow", function (done) {
      expect(function () {
        configAction = {
          $name: "sol.meeting.CreateMeeting",
