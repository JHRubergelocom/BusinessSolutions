...
describe("[service] sol.meeting.ix.services.GetProposal", function () {
  var originalTimeout, objTempId,
      configTypes, meetingBoardTypes, configAction,
      wfInfo, objIdMB, objIdM, objIdMI, meetingItemTypes,
      succNodes, succNodesIds, proposalTypes, objIdPr,
      sords, proposal, proposalTemplateSord,
      id, output, options, cfg, meetingItemReference;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("GetProposal").then(function success(objTempId1) {
  ...
  describe("create meeting item 'premium'", function () {
  ...
  describe("create proposal", function () {
    ...
    it("check precondition create proposal", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_meeting_service_CreateProposalPrecondition", { targetId: objIdMI }).then(function success(checkResult) {
    ...
    it("start action create workflow", function (done) {
      expect(function () {
        configAction = {
          ...
          $wf: {
            template: {
              name: "sol.meeting_premium.proposal.Create"
            },
          ...
          $new: {
            ...
            template: {
              base: "ARCPATH[(E10E1000-E100-E100-E100-E10E10E10E00)]:/Business Solutions/meeting_premium/Configuration/Proposal types",
              name: proposalTypes[0].name
            }
          },
          $metadata: {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.services.GetProposal", function () {
      it("get proposal sord", function (done) {
        expect(function () {
          test.Utils.getSord(objIdPr).then(function success1(sordProposal) {
            meetingItemReference = test.Utils.getObjKeyValue(sordProposal, "MEETING_ITEM_ID");
            done();
          }, function error(err) {
            fail(err);
            console.error(err);
      ...
      it("checkAndGet", function (done) {
        expect(function () {
          sords = [{}];
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.services.GetProposal",
            classConfig: { objId: objIdPr },
            method: "checkAndGet",
            params: [sords]
      ...
      it("collectProposalDocuments", function (done) {
        expect(function () {
          proposal = { objId: objIdPr };
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.services.GetProposal",
            classConfig: { objId: objIdPr },
            method: "collectProposalDocuments",
            params: [proposal]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
      ...
      it("findProposalContentDocument", function (done) {
        expect(function () {
          proposalTemplateSord = { objKeys: { MEETING_ITEM_ID: meetingItemReference } };
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.services.GetProposal",
            classConfig: { objId: objIdPr, options: {} },
            method: "findProposalContentDocument",
            params: [proposalTemplateSord]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
            fail(err);
      ...
      it("prepareArgsById", function (done) {
        expect(function () {
          id = {};
          output = {};
          options = {};
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.services.GetProposal",
            classConfig: { objId: objIdPr },
            method: "prepareArgsById",
            params: [id, output, options]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
            fail(err);
      ...
      it("prepareArgsBySearch", function (done) {
        expect(function () {
          cfg = {};
          output = {};
          options = {};
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.services.GetProposal",
            classConfig: { objId: objIdPr },
            method: "prepareArgsBySearch",
            params: [cfg, output, options]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
            fail(err);
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_service_GetProposal", function () {
      it("should not throw if executed without 'objId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_service_GetProposal", {
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
            fail(err);
