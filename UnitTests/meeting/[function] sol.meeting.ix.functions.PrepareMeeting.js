...
describe("[function] sol.meeting.ix.functions.PrepareMeeting", function () {
  var originalTimeout, objTempId, objIdM,
      configTypes, meetingBoardTypes, configAction, wfInfo,
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("PrepareMeeting").then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.functions.PrepareMeeting", function () {
      it("createAgendaScheduler", function (done) {
        expect(function () {
          items = [];
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.PrepareMeeting",
            classConfig: { objId: objIdM },
            method: "createAgendaScheduler",
            params: [items]
      ...
      it("getRefGenerator", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.PrepareMeeting",
            classConfig: { objId: objIdM },
            method: "getRefGenerator",
            params: []
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
      ...
      it("prepareAdditionalData", function (done) {
        expect(function () {
          item = {};
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.PrepareMeeting",
            classConfig: { objId: objIdM },
            method: "prepareAdditionalData",
            params: [item]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
      ...
      it("resetItemsToAgendaPool", function (done) {
        expect(function () {
          items = [];
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.PrepareMeeting",
            classConfig: { objId: objIdM },
            method: "resetItemsToAgendaPool",
            params: [items]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
      ...
      it("resetLocalItem", function (done) {
        expect(function () {
          item = {};
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.PrepareMeeting",
            classConfig: { objId: objIdM },
            method: "resetLocalItem",
            params: [item]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
      ...
      it("toFillSordConfig", function (done) {
        expect(function () {
          item = { objKeys: { MEETING_ITEM_ID: "T1" } };
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.PrepareMeeting",
            classConfig: { objId: objIdM },
            method: "toFillSordConfig",
            params: [item]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_function_PrepareMeeting", function () {
      it("should throw if executed without Parameter", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_function_PrepareMeeting", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("prepare meeting", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_function_PrepareMeeting", {
            objId: objIdM
          }).then(function success(jsonResult) {
