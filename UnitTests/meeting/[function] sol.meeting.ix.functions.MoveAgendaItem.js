...
describe("[function] sol.meeting.ix.functions.MoveAgendaItem", function () {
  var originalTimeout, objTempId, configTypes, meetingBoardTypes, configAction,
      wfInfo, objIdMB, succNodes, succNodesIds,
      objIdM, meetingItemTypes, objIdMI;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("MoveAgendaItem", null, null).then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.functions.MoveAgendaItem", function () {
      it("getId", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.MoveAgendaItem",
            classConfig: { objId: objIdMI, params: { targetMeetingId: objIdM } },
            method: "getId",
            params: []
      ...
      it("getTargetMeetingId", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.MoveAgendaItem",
            classConfig: { objId: objIdMI, params: { targetMeetingId: objIdM } },
            method: "getTargetMeetingId",
            params: []
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_function_MoveAgendaItem", function () {
      it("should throw if executed without 'objId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_function_MoveAgendaItem", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("move agenda item", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_function_MoveAgendaItem", {
            objId: objIdMI,
            params: { targetMeetingId: objIdM }
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
            fail(err);
