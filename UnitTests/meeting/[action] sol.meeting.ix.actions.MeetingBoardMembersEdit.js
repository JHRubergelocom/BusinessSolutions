...
describe("[action] sol.meeting.ix.actions.MeetingBoardMembersEdit", function () {
  var objTempId, meetingBoardTypes, configTypes, configAction, wfInfo, succNodes, succNodesIds,
      objIdMB, originalTimeout;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("Actions.MeetingBoardMembersEdit", null, null).then(function success(objTempId1) {
  ...
  describe("test meetingboard members edit", function () {
  ...
  describe("test finish meetingboard members edit", function () {
    it("start action create workflow", function (done) {
      expect(function () {
        configAction = {
          objId: objIdMB,
          ...
          $wf: {
            template: {
              name: "sol.meeting.meetingBoard.EditMemberList"
            },
            name: "{{translate 'sol.meeting.meetingBoard.editMembers.prefix'}}"
          },
          $events: [
            {
              id: "DIALOG",
            ...
            },
            {
              id: "FEEDBACK",
              onWfStatus: "CREATE",
              message: "{{translate 'sol.meeting.client.editMembers.feedback.create'}}"
            }
          ]
        };
        wfInfo = {};
    ...
    it("edit members", function (done) {
      expect(function () {
        test.Utils.updateWfMapData(wfInfo.flowId, wfInfo.objId, {
          MEETING_PERSON_FORM_OF_ADDRESS1: "Herr",
          MEETING_PERSON_LASTNAME1: "Administrator",
          MEETING_PERSON_FIRSTNAME1: "Administrator",
          MEETING_PERSON_EMAIL1: "Administrator@elo.com",
          MEETING_PERSON_CONTACT_REFERENCE: "C99",
          MEETING_PERSON_CONTACTLIST_NAME: "Kontakliste 99",
          MEETING_PERSON_CONTACTLIST_REFERENCE: "CL99",
          MEETING_PERSON_COMPANYNAME: "Contelo",
          MEETING_PERSON_USERNAME: "Administrator",
          MEETING_PERSON_ELOUSERID1: "0",
          MEETING_PERSON_CRUD_STATUS: "CREATE",
          MEETING_PARTICIPANT_ROLE: "M - Mitglied"
  ...
  describe("test cancel meetingboard members edit", function () {
    it("start action create workflow", function (done) {
      expect(function () {
        wfInfo = {};
        test.Utils.executeIxActionHandler("RF_sol_common_action_Standard", configAction, []).then(function success(jsonResults) {
