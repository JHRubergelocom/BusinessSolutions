...
describe("[action] sol.meeting.ix.actions.RecordMinutes", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("RecordMinutes").then(function success(objTempId) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.actions.RecordMinutes", function () {
      it("getName", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.actions.RecordMinutes",
            classConfig: { objId: objMeetingItemId, minutes: 30 },
            method: "getName",
            params: []
      ...
      it("storeTimestamp", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.actions.RecordMinutes",
            classConfig: { objId: objMeetingItemId, minutes: 30 },
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_function_RecordMinutes", function () {
      it("should throw if executed without 'objId' ", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_function_RecordMinutes", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("should throw if executed without 'minutes' ", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_function_RecordMinutes", {
