...
describe("[lib] sol.unittest.ix.services.SolMeetingRuleEngineExecutionProcessor", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("SolMeetingRuleEngineExecutionProcessor").then(function success(obSolMeetingRuleEngineExecutionProcessorId) {
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.RuleEngineExecutionProcessor", function () {
      it("process", function (done) {
        expect(function () {
          ...
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib", {
            className: "sol.meeting.ix.RuleEngineExecutionProcessor",
