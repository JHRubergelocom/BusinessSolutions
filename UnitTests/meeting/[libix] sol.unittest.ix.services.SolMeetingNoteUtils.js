...
describe("[libix] sol.unittest.ix.services.SolMeetingNoteUtils", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("SolMeetingNoteUtils").then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.note.ix.NoteUtils", function () {
      it("findNotesFolder", function (done) {
        expect(function () {
          objId = objIdMI;
          solType = "MEETING_ITEM_NOTE_LIST";
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib", {
            className: "sol.meeting.note.ix.NoteUtils",
            classConfig: {},
            method: "findNotesFolder",
      ...
      it("isMeetingNote", function (done) {
        expect(function () {
          sords = [];
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib", {
            className: "sol.meeting.note.ix.NoteUtils",
            classConfig: {},
            method: "isMeetingNote",
            params: [sords]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
