...
describe("[dynkwl] sol.meeting.ix.dynkwls.SpeakerUserNames", function () {
  var originalTimeout, objSpeakerUserNamesId;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("SpeakerUserNames").then(function success(objSpeakerUserNamesId1) {
        objSpeakerUserNamesId = objSpeakerUserNamesId1;
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
