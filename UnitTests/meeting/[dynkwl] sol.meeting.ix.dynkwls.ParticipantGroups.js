...
describe("[dynkwl] sol.meeting.ix.dynkwls.ParticipantGroups", function () {
  var originalTimeout, objParticipantGroupsId, kwlConfig;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("ParticipantGroups").then(function success(objParticipantGroupsId1) {
        objParticipantGroupsId = objParticipantGroupsId1;
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
