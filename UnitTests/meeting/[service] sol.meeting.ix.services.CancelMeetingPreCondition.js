...
describe("[service] sol.meeting.ix.services.CancelMeetingPreCondition", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("CancelMeetingPreCondition").then(function success(objTempId) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.services.CancelMeetingPreCondition", function () {
      it("checkPreCondition", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.services.CancelMeetingPreCondition",
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_service_CancelMeetingPreCondition", function () {
      it("should throw if executed without Parameter 'targetId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_service_CancelMeetingPreCondition", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("nacel meeting precondition", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_service_CancelMeetingPreCondition", {
