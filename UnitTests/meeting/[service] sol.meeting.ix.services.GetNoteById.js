...
describe("[service] sol.meeting.ix.services.GetNoteById", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("GetNoteById").then(function success(objTempId1) {
  ...
  describe("create note", function () {
    it("create Note", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_meeting_note_function_CreateNote", {
          source: {
            text: "Sord Name PU V",
            title: "Test",
          ...
          params: { rootId: objIdMI }
        }).then(function success(jsonResult) {
          objIdN = jsonResult.objId;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.note.ix.services.GetNoteById", function () {
      it("checkResult", function (done) {
        searchResult = {};
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.note.ix.services.GetNoteById",
            classConfig: { objId: objIdN },
            method: "checkResult",
            params: [searchResult]
          }).then(function success(jsonResult) {
            done();
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_note_services_GetNoteById", function () {
      it("should throw if executed without Parameter 'objId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_note_services_GetNoteById", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("delete note", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_note_services_GetNoteById", {
            ...
            expect(jsonResult.editedBy).toBeDefined();
            expect(jsonResult.minutesRelevant).toBeDefined();
            expect(jsonResult.lastEdited).toBeDefined();
            expect(jsonResult.visibility).toBeDefined();
            expect(jsonResult.status).toBeDefined();
            expect(jsonResult.title).toBeDefined();
            expect(jsonResult.solType).toBeDefined();
            expect(jsonResult.accessCode).toBeDefined();
            expect(jsonResult.text).toBeDefined();
            expect(jsonResult.ownerId).toBeDefined();
            expect(jsonResult.fillingDate).toBeDefined();
            expect(jsonResult.ownerName).toBeDefined();
