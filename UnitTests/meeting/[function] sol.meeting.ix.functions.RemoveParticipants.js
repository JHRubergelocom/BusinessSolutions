...
describe("[function] sol.meeting.ix.functions.RemoveParticipants", function () {
  var originalTimeout, objTempId, objIdM,
      configTypes, meetingBoardTypes, configAction, wfInfo,
      objIdMB, succNodes, succNodesIds, config;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("RemoveParticipants").then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.functions.RemoveParticipants", function () {
      it("initialize", function (done) {
        expect(function () {
          config =  { objId: objIdM };
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.RemoveParticipants",
