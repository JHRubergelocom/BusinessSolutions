...
describe("[service] sol.meeting.ix.services.CreateMeetingMinutesPrecondition", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("CreateMeetingMinutesPrecondition").then(function success(objTempId) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.services.CreateMeetingMinutesPrecondition", function () {
      it("checkPreCondition", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.services.CreateMeetingMinutesPrecondition",
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_service_CreateMeetingMinutesPrecondition", function () {
      it("should throw if executed without Parameter 'targetId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_service_CreateMeetingMinutesPrecondition", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("meeting minutes precondition", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_service_CreateMeetingMinutesPrecondition", {
