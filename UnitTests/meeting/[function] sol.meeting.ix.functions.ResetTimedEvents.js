...
describe("[function] sol.meeting.ix.functions.ResetTimedEvents", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("ResetTimedEvents").then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.functions.ResetTimedEvents", function () {
      it("findTimedEvents", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.ResetTimedEvents",
            classConfig: { objId: objIdM, mode: "CLEAR" },
            method: "findTimedEvents",
            params: []
