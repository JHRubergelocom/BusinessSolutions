...
describe("[service] sol.meeting.ix.services.MeetingApprovalPreCondition", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("MeetingApprovalPreCondition").then(function success(objTempId) {
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_premium_service_MeetingApprovalPreCondition", function () {
      it("should not throw if executed without Parameter 'targetId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_premium_service_MeetingApprovalPreCondition", {
