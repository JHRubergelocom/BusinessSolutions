...
describe("[function] sol.meeting.ix.functions.EditNote", function () {
  var originalTimeout, objTempId, configTypes, meetingBoardTypes, configAction,
      wfInfo, objIdMB, succNodes, succNodesIds,
      objIdM, meetingItemTypes, objIdMI, objIdN, config;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("EditNote", null, null).then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.note.ix.functions.EditNote", function () {
      it("initialize", function (done) {
        expect(function () {
          config = {};
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.note.ix.functions.EditNote",
            classConfig: {
              objId: objIdN
            },
            method: "initialize",
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_note_function_EditNote", function () {
      it("should throw if executed without 'objId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_note_function_EditNote", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
