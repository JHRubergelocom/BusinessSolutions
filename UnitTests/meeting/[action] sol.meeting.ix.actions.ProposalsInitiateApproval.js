      ...
      expect(function () {
        test.Utils.getSord(wfInfo.objId).then(function success(sordM1) {
          ...
          test.Utils.updateKeywording(sordM1, { 
            ...
            MEETING_PROVIDED_PROPOSALTYPES: "Antrag"
        ...
        test.Utils.deleteSord(tempfolder).then(function success1(deleteResult) {
          test.Utils.deleteSord(objIdM).then(function success2(deleteResult1) {
            test.Utils.deleteSord(objIdMI).then(function success3(deleteResult2) {
              test.Utils.deleteSord(objIdPr).then(function success4(deleteResult3) {
                test.Utils.getFinishedWorkflows().then(function success5(wfs) {
                  test.Utils.removeFinishedWorkflows(wfs).then(function success6(removeFinishedWorkflowsResult) {
                    done();
                  }, function error(err) {
                    fail(err);
                    console.error(err);
