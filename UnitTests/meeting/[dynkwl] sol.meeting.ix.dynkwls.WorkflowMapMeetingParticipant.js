...
describe("[dynkwl] sol.meeting.ix.dynkwls.WorkflowMapMeetingParticipant", function () {
  var originalTimeout, objWorkflowMapMeetingParticipantId, kwlConfig;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("WorkflowMapMeetingParticipant").then(function success(objWorkflowMapMeetingParticipantId1) {
