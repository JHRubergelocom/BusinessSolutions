...
describe("[libix] sol.unittest.ix.services.SolMeetingNote", function () {
  var originalTimeout, objTempId, configTypes, meetingBoardTypes, configAction,
      wfInfo, objIdMB, succNodes, succNodesIds, permissions,
      objIdM, meetingItemTypes, objIdMI, objIdN, objId;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.note.ix.Note", function () {
      it("initialize", function (done) {
        expect(function () {
          objId = objIdN;
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.note.ix.Note",
            classConfig: {},
            method: "initialize",
            params: [objId]
          }).then(function success(jsonResult) {
