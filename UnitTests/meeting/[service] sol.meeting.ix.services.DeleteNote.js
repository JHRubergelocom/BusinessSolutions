...
describe("[service] sol.meeting.ix.services.DeleteNote", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("DeleteNote").then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.note.ix.services.DeleteNote", function () {
      it("deleteNote", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.note.ix.services.DeleteNote",
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_note_service_DeleteNote", function () {
      it("should throw if executed without Parameter 'objId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_note_service_DeleteNote", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
