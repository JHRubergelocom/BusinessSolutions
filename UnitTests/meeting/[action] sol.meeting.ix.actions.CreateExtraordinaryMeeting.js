...
describe("[action] sol.meeting.ix.actions.CreateExtraordinaryMeeting", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.CreateExtraordinaryMeeting", null, null).then(function success(objTempId1) {
  ...
  describe("test create extraordinary meeting", function () {
  ...
  describe("test finish createextraordinarymeeting", function () {
    ...
    it("start action create workflow", function (done) {
      expect(function () {
        configAction = {
          ...
          $name: "CreateExtraordinaryMeeting",
          $metadata: {
            solType: "MEETING",
            owner: {
              fromConnection: true
          ...
          $wf: {
            template: {
              name: "sol.meeting_premium.CreateExtraordinaryMeeting"
            },
            name: "{{translate 'sol.meeting_premium.createExtraordinary.prefix'}}"
          },
          $events: [
            {
              id: "DIALOG",
  ...
  describe("test cancel createextraordinarymeeting", function () {
    it("find meetingboardTypes", function (done) {
      test.Utils.execute("RF_sol_meeting_function_FindMeetingBoardTypes", {
        objId: objIdMB
      }).then(function success(meetingBoardTypes1) {
