...
describe("[action] sol.meeting.ix.actions.ProposalCreate", function () {
  var objTempId, meetingBoardTypes, configTypes, configAction, wfInfo, succNodes, succNodesIds,
      objIdMB, objIdM, objIdMI, originalTimeout, meetingItemTypes, proposalTypes;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("Actions.ProposalCreate", null, null).then(function success(objTempId1) {
  ...
  describe("test proposal create", function () {
  ...
  describe("test finish proposal create", function () {
  ...
  describe("test cancel proposalcreate", function () {
    it("proposalTypes must be available", function (done) {
      configTypes = {
        objId: objIdMB
      };
