...
describe("[function] sol.meeting.ix.functions.GenerateMeetingItemShortDesc", function () {
  var originalTimeout, sordMeetingItem, shortDescription;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.functions.generators.MeetingItemShortDesc", function () {
      it("getIdentifier", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.generators.MeetingItemShortDesc",
