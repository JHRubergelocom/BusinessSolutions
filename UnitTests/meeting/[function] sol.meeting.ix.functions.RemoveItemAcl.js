...
describe("[function] sol.meeting.ix.functions.RemoveItemAcl", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("RemoveItemAcl").then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.functions.RemoveItemAcl", function () {
      it("findItemFolder", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.RemoveItemAcl",
            classConfig: { objId: objIdM },
            method: "findItemFolder",
            params: []
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_function_RemoveItemAcl", function () {
      it("should throw if executed without Parameter", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_function_RemoveItemAcl", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("remove item acl", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_function_RemoveItemAcl", {
            objId: objIdM
          }).then(function success(jsonResult) {
