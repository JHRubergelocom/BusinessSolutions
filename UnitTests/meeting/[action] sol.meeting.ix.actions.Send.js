...
describe("[action] sol.meeting.ix.actions.Send", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.Send", null, null).then(function success(objTempId1) {
  ...
  describe("test finish send 'default'", function () {
    it("check precondition send", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_meeting_service_OrganizerPrecondition", { targetId: objIdM }).then(function success(checkResult) {
    ...
    it("start action create workflow", function (done) {
      expect(function () {
        configAction = {
          objId: objIdM,
          $name: "MeetingNotificationSendNotification",
          $wf: {
            template: {
              name: "sol.meeting.notification.Send"
            },
            name: "{{translate 'sol.meeting.client.ribbon.btnNotification.sendNotification.workflowName'}}"
          },
          $events: [
            {
              id: "DIALOG",
            ...
            },
            {
              id: "FEEDBACK",
              onWfStatus: "SEND",
              message: "{{translate 'sol.meeting.client.notification.sendNotification.feedback.send'}}"
            },
            {
              id: "GOTO",
              onWfStatus: "CREATED",
  ...
  describe("test cancel send 'default'", function () {
    it("check precondition send", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_meeting_service_OrganizerPrecondition", { targetId: objIdM }).then(function success(checkResult) {
          expect(checkResult.valid).toEqual(true);
  ...
  describe("test finish send 'Premium'", function () {
    it("check precondition send", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_meeting_service_OrganizerPrecondition", { targetId: objIdM }).then(function success(checkResult) {
          expect(checkResult.valid).toEqual(true);
    ...
    it("start action create workflow", function (done) {
      expect(function () {
        configAction = {
          ...
          $wf: {
            template: {
              name: "sol.meeting.Postpone"
            },
            name: "{{translate 'sol.meeting.postpone.workflow.name'}}"
          },
          $events: [
            {
              id: "DIALOG",
  ...
  describe("test cancel send 'Premium'", function () {
    it("check precondition send", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_meeting_service_OrganizerPrecondition", { targetId: objIdM }).then(function success(checkResult) {
          expect(checkResult.valid).toEqual(true);
