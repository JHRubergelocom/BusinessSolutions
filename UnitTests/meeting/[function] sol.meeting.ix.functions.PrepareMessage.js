...
describe("[function] sol.meeting.ix.functions.PrepareMessage", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("PrepareMessage", null, null).then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.functions.PrepareMessage", function () {
      ...
      it("getRecipientId", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.PrepareMessage",
            classConfig: { objId: objIdMI },
      ...
      it("prepareMapKeys", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.PrepareMessage",
            classConfig: { objId: objIdMI },
            method: "prepareMapKeys",
            params: []
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
      ...
      it("prepareObjKeys", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.PrepareMessage",
            classConfig: { objId: objIdMI },
            method: "prepareObjKeys",
            params: []
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_function_PrepareMessage", function () {
      it("should throw if executed without 'objId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_function_PrepareMessage", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("prepare message", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_function_PrepareMessage", {
            objId: objIdMI
          }).then(function success(jsonResult) {
