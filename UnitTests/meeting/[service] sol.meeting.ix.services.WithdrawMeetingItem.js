...
describe("[service] sol.meeting.ix.services.WithdrawMeetingItem", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("WithdrawMeetingItem").then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.services.WithdrawMeetingItem", function () {
      it("getLink", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.services.WithdrawMeetingItem",
      ...
      it("getMeetingItemIDByLink", function (done) {
        expect(function () {
          link = {};
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.services.WithdrawMeetingItem",
            classConfig: { objId: objIdMI },
            method: "getMeetingItemIDByLink",
            params: [link]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
      ...
      it("setObjIdToLinkedItem", function (done) {
        expect(function () {
          link = {};
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.services.WithdrawMeetingItem",
            classConfig: { objId: objIdMI },
            method: "setObjIdToLinkedItem",
            params: [link]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_service_WithdrawMeetingItem", function () {
      it("should throw if executed without 'objId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_service_WithdrawMeetingItem", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("with draw meetingitem", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_service_WithdrawMeetingItem", {
            objId: objIdMI
          }).then(function success(jsonResult) {
