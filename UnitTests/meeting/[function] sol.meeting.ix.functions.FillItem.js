...
describe("[function] sol.meeting.ix.functions.FillItem", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("FillItem").then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.function.FillItem", function () {
      it("fillItem", function (done) {
        expect(function () {
          item = { id: objIdMI };
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.function.FillItem",
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_function_FillItem", function () {
      it("should throw if executed without Parameter", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_function_FillItem", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
