...
describe("[function] sol.meeting.ix.functions.CreateNote", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("CreateNote", null, null).then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.note.ix.functions.CreateNote", function () {
      it("buildArgs", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.note.ix.functions.CreateNote",
            classConfig: {
              source: {
                text: "Sord Name PU V",
                title: "Test",
      ...
      it("getFromService", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.note.ix.functions.CreateNote",
            classConfig: {
      ...
      it("getMutatorFunction", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.note.ix.functions.CreateNote",
            classConfig: {
      ...
      it("shouldIncludeResult", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.note.ix.functions.CreateNote",
            classConfig: {
      ...
      it("useCopySordKeys", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.note.ix.functions.CreateNote",
            classConfig: {
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_note_function_CreateNote", function () {
