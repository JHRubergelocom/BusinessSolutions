...
describe("[action] sol.meeting.ix.actions.EditParticipantList", function () {
  var objTempId, meetingBoardTypes, configTypes, configAction, wfInfo, succNodes, succNodesIds,
      objIdMB, objIdM, originalTimeout;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("Actions.EditParticipantList", null, null).then(function success(objTempId1) {
  ...
  describe("test edit participantlist", function () {
  ...
  describe("test finish EditParticipantList", function () {
    it("start action create workflow", function (done) {
      expect(function () {
        configAction = {
          objId: objIdM,
          ...
          $wf: {
            template: {
              name: "sol.meeting.EditParticipantList"
            },
            name: "{{translate 'sol.meeting.editParticipantList.prefix'}}"
          },
          $events: [
            {
              id: "DIALOG",
            ...
            },
            {
              id: "FEEDBACK",
              onWfStatus: "CREATE",
              message: "{{translate 'sol.meeting.client.editParticipants.feedback.create'}}"
            }
          ]
        };
        wfInfo = {};
    ...
    it("fill participants", function (done) {
      expect(function () {
        test.Utils.updateWfMapData(wfInfo.flowId, wfInfo.objId, {
          ...
          MEETING_PARTICIPANT_ROLE: "P - Teilnehmer"
  ...
  describe("test cancel EditParticipantList", function () {
    it("start action create workflow", function (done) {
      expect(function () {
        configAction = {
          objId: objIdM,
