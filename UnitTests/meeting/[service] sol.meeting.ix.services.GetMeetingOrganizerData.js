...
describe("[service] sol.meeting.ix.services.GetMeetingOrganizerData", function () {
  var originalTimeout, objTempId, meetingBoardTypes, configTypes, configAction, wfInfo, succNodes, succNodesIds,
      objIdMB, objIdM, recipientName, config;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("ServicesGetMeetingOrganizerData").then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.services.GetMeetingOrganizerData", function () {
      it("findFallbackFolder", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.services.GetMeetingOrganizerData",
            classConfig: { objId: objIdM },
            method: "findFallbackFolder",
            params: []
      ...
      it("findRecipient", function (done) {
        expect(function () {
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_service_GetMeetingOrganizerData", function () {
      it("should not throw if executed without Parameter", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_service_GetMeetingOrganizerData", {
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
            fail(err);
