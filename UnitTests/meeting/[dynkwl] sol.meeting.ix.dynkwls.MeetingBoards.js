...
describe("[dynkwl] sol.meeting.ix.dynkwls.MeetingBoards", function () {
  var originalTimeout, objParticipantCompanynameId,
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("MeetingBoards").then(function success(objParticipantCompanynameId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.dynkwl.MeetingBoards", function () {
      it("getFindInfo", function (done) {
        expect(function () {
          filterList = [];
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.dynkwl.MeetingBoards",
            classConfig: {},
            method: "getFindInfo",
            params: [filterList]
    ...
    describe("sol.meeting.ix.dynkwl.MeetingBoards", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteDynKwl", {
            objId: objParticipantCompanynameId,
            dynKwl: "sol.meeting.ix.dynkwl.MeetingBoards"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
