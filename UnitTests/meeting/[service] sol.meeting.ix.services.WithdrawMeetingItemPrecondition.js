...
describe("[service] sol.meeting.ix.services.WithdrawMeetingItemPrecondition ", function () {
  var originalTimeout, objTempId, meetingBoardTypes, configTypes, configAction,
      wfInfo, succNodes, succNodesIds, objIdMB, objIdM, meetingItemTypes, objIdMI,
      result, prop, data, meeting, premiumKey, meetingKey;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("WithdrawMeetingItemPrecondition ").then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.services.WithdrawMeetingItemPrecondition", function () {
      it("appendInDebugMode", function (done) {
        expect(function () {
          ...
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.services.WithdrawMeetingItemPrecondition",
            classConfig: { targetId: objIdMI },
      ...
      it("getTranslationKey", function (done) {
        expect(function () {
          premiumKey = "sol.meeting_premium.item.withdraw.errorRecurringItem";
          meetingKey = "sol.meeting.item.withdraw.errorRecurringItem";
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.services.WithdrawMeetingItemPrecondition",
            classConfig: { targetId: objIdMI },
            method: "getTranslationKey",
            params: [premiumKey, meetingKey]
          }).then(function success(jsonResult) {
            done();
          }, function error(err) {
            fail(err);
