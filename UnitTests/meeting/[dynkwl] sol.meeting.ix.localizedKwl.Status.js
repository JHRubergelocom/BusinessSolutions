...
describe("[dynkwl] sol.meeting.ix.localizedKwl.Status", function () {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.note.ix.localizedKwl.Status", function () {
      it("initialize", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.note.ix.localizedKwl.Status",
            classConfig: {},
            method: "initialize",
            params: []
    ...
    describe("sol.meeting.voting.ix.localizedKwl.Status", function () {
      it("initialize", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.voting.ix.localizedKwl.Status",
            classConfig: {},
            method: "initialize",
            params: []
          }).then(function success(jsonResult) {
    ...
    describe("sol.meeting.note.ix.localizedKwl.Status", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteDynKwl", {
            objId: objStatusId,
            dynKwl: "sol.meeting.note.ix.localizedKwl.Status"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
    ...
    describe("sol.meeting.voting.ix.localizedKwl.Status", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteDynKwl", {
            objId: objStatusId,
            dynKwl: "sol.meeting.voting.ix.localizedKwl.Status"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
