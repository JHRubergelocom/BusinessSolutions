...
describe("[function] sol.meeting.ix.functions.CalcNextRecurringItemNo", function () {
  var originalTimeout, objTempId, configTypes, meetingBoardTypes,
      configAction, wfInfo, objIdMB, succNodes, succNodesIds,
      meetingItemTypes, objMeetingItemId;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("CalcNextRecurringItemNo").then(function success(objTempId1) {
  ...
  describe("add recurring item 'default'", function () {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.functions.CalcNextRecurringItemNo", function () {
      it("findRecurringItemFolder", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.functions.CalcNextRecurringItemNo",
            classConfig: { objId: objMeetingItemId },
            method: "findRecurringItemFolder",
            params: []
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_function_CalcNextRecurringItemNo", function () {
      it("should throw if executed without Parameter", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_function_CalcNextRecurringItemNo", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("calc next recurring item no", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_function_CalcNextRecurringItemNo", {
