...
describe("[action] sol.meeting.ix.actions.CancelMeeting", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.CancelMeeting", null, null).then(function success(objTempId1) {
  ...
  describe("test cancelmeeting", function () {
  ...
  describe("test finish cancelmeeting 'default'", function () {
    it("check precondition cancel meeting", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_meeting_service_CancelMeetingPreCondition", { targetId: objIdM }).then(function success(checkResult) {
    ...
    it("start action create workflow", function (done) {
      expect(function () {
        configAction = {
          ...
          $wf: {
            template: {
              name: "sol.meeting.CancelMeeting"
            },
            name: "{{translate 'sol.meeting.cancel.workflow.name'}}"
          },
          $events: [
            {
              id: "DIALOG",
  ...
  describe("test cancel cancelmeeting 'default'", function () {
    it("check precondition cancel meeting", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_meeting_service_CancelMeetingPreCondition", { targetId: objIdM }).then(function success(checkResult) {
  ...
  describe("test finish cancelmeeting 'Premium'", function () {
    it("check precondition cancel meeting", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_meeting_service_CancelMeetingPreCondition", { targetId: objIdM }).then(function success(checkResult) {
          expect(checkResult.valid).toEqual(true);
  ...
  describe("test cancel cancelmeeting 'Premium'", function () {
    it("check precondition cancel meeting", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_meeting_service_CancelMeetingPreCondition", { targetId: objIdM }).then(function success(checkResult) {
          expect(checkResult.valid).toEqual(false);
