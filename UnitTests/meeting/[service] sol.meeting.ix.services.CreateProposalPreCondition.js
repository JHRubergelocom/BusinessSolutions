...
describe("[service] sol.meeting.ix.services.CreateProposalPreCondition", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("CreateProposalPreCondition").then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.services.CreateProposalPreCondition", function () {
      it("process", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.services.CreateProposalPreCondition",
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_service_CreateProposalPrecondition", function () {
      it("should throw if executed without Parameter 'targetId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_service_CreateProposalPrecondition", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("create proposal precondition", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_service_CreateProposalPrecondition", {
            targetId: objIdMI
          }).then(function success(jsonResult) {
