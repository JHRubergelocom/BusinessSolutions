...
describe("[action] sol.meeting.ix.actions.MoveItem", function () {
  var originalTimeout, objMeetingItemId;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("MoveItem").then(function success(objTempId) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.actions.MoveItem", function () {
      it("getMeetingItem", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.actions.MoveItem",
            classConfig: { id: objMeetingItemId },
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_action_MoveItem", function () {
      it("should throw if executed without 'id' ", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_action_MoveItem", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
