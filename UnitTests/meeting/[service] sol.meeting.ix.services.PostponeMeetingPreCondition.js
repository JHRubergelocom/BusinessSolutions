...
describe("[service] sol.meeting.ix.services.PostponeMeetingPreCondition", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("PostponeMeetingPreCondition").then(function success(objTempId) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.services.PostponeMeetingPreCondition", function () {
      it("checkPreCondition", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.services.PostponeMeetingPreCondition",
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_meeting_service_PostponeMeetingPreCondition", function () {
      it("should throw if executed without Parameter 'targetId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_service_PostponeMeetingPreCondition", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("postpone meeting precondition", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_meeting_service_PostponeMeetingPreCondition", {
