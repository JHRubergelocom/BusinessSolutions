...
describe("[dynkwl] sol.meeting.ix.dynkwls.TargetMeeting", function () {
  var originalTimeout, objTargetMeetingId,
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("TargetMeeting").then(function success(objTargetMeetingId1) {
        objTargetMeetingId = objTargetMeetingId1;
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("Test Lib Functions", function () {
    describe("sol.meeting.ix.dynkwl.TargetMeeting", function () {
      it("getFindInfo", function (done) {
        expect(function () {
          filterList = [];
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteLib1", {
            className: "sol.meeting.ix.dynkwl.TargetMeeting",
            classConfig: {},
            method: "getFindInfo",
            params: [filterList]
    ...
    describe("sol.meeting.ix.dynkwl.TargetMeeting", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteDynKwl", {
            objId: objTargetMeetingId,
            dynKwl: "sol.meeting.ix.dynkwl.TargetMeeting"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
