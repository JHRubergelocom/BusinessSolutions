...
describe("[dynkwl] sol.meeting.ix.localizedKwl.CalendarUnit", function () {
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.meeting.ix.dynkwl.CalendarUnit", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_meeting_service_ExecuteDynKwl", {
            objId: objCalendarUnitId,
            dynKwl: "sol.meeting.ix.localizedKwl.CalendarUnit"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
