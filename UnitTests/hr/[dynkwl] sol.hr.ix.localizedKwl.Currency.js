...
describe("[dynkwl] sol.hr.ix.localizedKwl.Currency", function () {
  var originalTimeout, objCurrencyId;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.hr.ix.localizedKwl.Currency", function () {
      it("initialize", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_hr_service_ExecuteLib1", {
            className: "sol.hr.ix.localizedKwl.Currency",
            classConfig: {},
            method: "initialize",
            params: []
    ...
    describe("sol.hr.ix.localizedKwl.Currency", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_hr_service_ExecuteDynKwl", {
            objId: objCurrencyId,
            dynKwl: "sol.hr.ix.localizedKwl.Currency"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
