...
describe("[action] sol.hr.ix.actions.DeleteEmployeePicture", function () {
  var personnelFileTypes, objSmileyBase64Id, base64Content,
      configAction, wfInfo, succNodes, succNodesIds, objIdHr1, objIdHr2,
      maskName, pictureName, pictureGuid, pictureId, originalTimeout, interval;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("Actions.DeleteEmployeePicture", null, null).then(function success(objTempId) {
        interval = 4000;
  ...
  describe("test delete employee picture", function () {
    ...
    describe("captureemployeepicture", function () {
    ...
    describe("test finish deleteemployeepicture", function () {
      it("start action deletepicture workflow", function (done) {
        expect(function () {
          configAction = {
            objId: objIdHr1,
            $name: "DeleteEmployeePicture",
            $wf: {
              name: "{{translate 'sol.hr.personnel.workflow.deletepicture.message'}}",
              template: { 
                name: "sol.hr.personnel.DeletePicture"
              }
            },
            $events: [
              {
    ...
    describe("test cancel deleteemployeepicture", function () {
      it("start action deletepicture workflow", function (done) {
        expect(function () {
          configAction = {
            objId: objIdHr2,
