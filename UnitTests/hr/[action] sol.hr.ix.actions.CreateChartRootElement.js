...
describe("[action] sol.hr.ix.actions.CreateChartRootElement", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.CreateChartRootElement", null, null).then(function success(objTempId1) {
        interval = 4000;
        done();
      }, function error(err) {
        fail(err);
  ...
  describe("test start create chart root element", function () {
    ...
    describe("'OK'", function () {
      ...
      describe("test finish createchartrootelement", function () {
        ...
        it("chartRootTypes must be available", function () {
          expect(chartRootTypes).toBeDefined();
        });
        it("chartRootTypes.length must greater than zero", function () {
          expect(chartRootTypes.length).toBeGreaterThan(0);
        });
    ...
    describe("'Cancel'", function () {
      ...
      describe("test cancel createchartrootelement", function () {
        it("get chartroot types", function (done) {
          expect(function () {
            test.Utils.execute("RF_sol_hr_service_GetChartRootTypes", {
              targetId: objIdHr
