 ...
 *
 */
sol.define("sol.unittest.hr.ix.services.ExecuteLib", {
...
/**
 * @member sol.unittest.hr.ix.services.ExecuteLib
 * @method RF_sol_unittest_hr_service_ExecuteLib
 * @static
 * @inheritdoc sol.unittest.ix.ServiceBase#RF_ServiceBaseName
 */
function RF_sol_unittest_hr_service_ExecuteLib(ec, args) {
  var params, service, result;
  logger.enter("RF_sol_unittest_hr_service_ExecuteLib", args);

  params = sol.common.ix.RfUtils.parseAndCheckParams(ec, arguments.callee.name, args, "className", "classConfig", "method", "params");
  params.ec = ec;
  service = sol.create("sol.unittest.hr.ix.services.ExecuteLib", params);
