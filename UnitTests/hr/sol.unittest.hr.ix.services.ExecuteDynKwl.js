...
//@include sol.hr.ix.localizedKwl.Country.js
//@include sol.hr.ix.localizedKwl.Currency.js
//@include sol.hr.ix.localizedKwl.EmergencyContactType.js
//@include sol.hr.ix.localizedKwl.FamilyMemberType.js
//@include sol.hr.ix.localizedKwl.FirstLanguage.js
//@include sol.hr.ix.localizedKwl.Gender.js
//@include sol.hr.ix.localizedKwl.PersonnelStatus.js
//@include sol.hr.ix.localizedKwl.ReligiousDenomination.js
//@include sol.hr.ix.localizedKwl.SecurityClassification.js
//@include sol.hr.ix.localizedKwl.TerminationPoint.js
//@include sol.hr.ix.localizedKwl.WorkscheduleRegulation.js

var logger = sol.create("sol.Logger", { scope: "sol.unittest.hr.ix.services.ExecuteDynKwl" });
 ...
 *
 *
 *     sol.common.IxUtils.execute('RF_sol_unittest_hr_service_ExecuteDynKwl', {
 *       objId: 5201,
 ...
 *
 */
sol.define("sol.unittest.hr.ix.services.ExecuteDynKwl", {
...
/**
 * @member sol.unittest.hr.ix.services.ExecuteDynKwl
 * @method RF_sol_unittest_hr_service_ExecuteDynKwl
 * @static
 * @inheritdoc sol.unittest.ix.ServiceBase#RF_ServiceBaseName
 */
function RF_sol_unittest_hr_service_ExecuteDynKwl(ec, args) {
  var params, service, result;
  logger.enter("RF_sol_unittest_hr_service_ExecuteDynKwl", args);
  ...
  params.ec = ec;
  service = sol.create("sol.unittest.hr.ix.services.ExecuteDynKwl", params);
  result = service.process();
  logger.exit("RF_sol_unittest_hr_service_ExecuteDynKwl", result);
