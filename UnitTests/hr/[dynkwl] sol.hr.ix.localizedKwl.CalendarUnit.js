...
describe("[dynkwl] sol.hr.ix.localizedKwl.CalendarUnit", function () {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.hr.ix.localizedKwl.CalendarUnit", function () {
      it("initialize", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_hr_service_ExecuteLib1", {
            className: "sol.hr.ix.localizedKwl.CalendarUnit",
            classConfig: {},
            method: "initialize",
            params: []
    ...
    describe("sol.hr.ix.localizedKwl.CalendarUnit", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_hr_service_ExecuteDynKwl", {
            objId: objCalendarUnitId,
            dynKwl: "sol.hr.ix.localizedKwl.CalendarUnit"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
