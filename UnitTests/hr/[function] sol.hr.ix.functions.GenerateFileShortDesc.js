...
describe("[function] sol.hr.ix.functions.GenerateFileShortDesc", function () {
  var originalTimeout, sordPersonnelFile, shortDescription;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.hr.ix.functions.generators.GenerateFileShortDesc", function () {
      it("getIdentifier", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_hr_service_ExecuteLib1", {
            className: "sol.hr.ix.functions.generators.GenerateFileShortDesc",
