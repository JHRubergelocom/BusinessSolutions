...
describe("[dynkwl] sol.hr.ix.dynkwls.CostCenter", function () {
  var originalTimeout, objCostCenterId;
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.hr.ix.dynkwl.CostCenter", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_hr_service_ExecuteDynKwl", {
            objId: objCostCenterId,
            dynKwl: "sol.hr.ix.dynkwl.CostCenter"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("should not throw", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_hr_service_ExecuteDynKwl", {
            objId: objCostCenterId,
            dynKwl: "sol.hr.ix.dynkwl.CostCenter",
            providerConfig: { sqlParams: ["1000", "C", "C"] },
