...
describe("[libas] sol.unittest.as.services.SolContractActionsPrepareDocument", function () {
  var objTempId, objDocumentTemplateId, originalTimeout, content, name, sord, config;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("SolContractActionsPrepareDocument").then(function success(objTempId1) {
      ...
      it("process", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_common_service_ExecuteAsAction", {
            ...
            config: {
              className: "sol.contract.as.actions.PrepareDocument",
              classConfig: { templateId: objDocumentTemplateId, parentId: objTempId },
              method: "process",
              params: []
            }
          }).then(function success(jsonResult) {
