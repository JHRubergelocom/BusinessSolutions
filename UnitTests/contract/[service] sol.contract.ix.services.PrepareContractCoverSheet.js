...
describe("[service] sol.contract.ix.services.PrepareContractCoverSheet", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("PrepareContractCoverSheet").then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.contract.ix.services.PrepareContractCoverSheet", function () {
      ...
      it("checkPreconditions", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_contract_service_ExecuteLib1", {
            className: "sol.contract.ix.services.PrepareContractCoverSheet",
