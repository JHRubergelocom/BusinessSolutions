...
describe("[dynkwl] sol.contract.ix.dynkwls.Clauses", function () {
  var originalTimeout, objClausesId,
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Clauses").then(function success(objClausesId1) {
        objClausesId = objClausesId1;
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
    ...
    describe("sol.contract.ix.dynkwl.Clauses", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_contract_service_ExecuteDynKwl1", {
            objId: objClausesId,
            dynKwl: "sol.contract.ix.dynkwl.Clauses"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
