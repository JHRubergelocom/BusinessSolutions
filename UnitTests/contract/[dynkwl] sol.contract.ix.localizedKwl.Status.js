...
describe("[dynkwl] sol.contract.ix.localizedKwl.Status", function () {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.contract.ix.localizedKwl.Status", function () {
      it("initialize", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_contract_service_ExecuteLib1", {
            className: "sol.contract.ix.localizedKwl.Status",
            classConfig: {},
            method: "initialize",
            params: []
    ...
    describe("sol.contract.ix.localizedKwl.Status", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_contract_service_ExecuteDynKwl", {
            objId: objStatusId,
            dynKwl: "sol.contract.ix.localizedKwl.Status"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
