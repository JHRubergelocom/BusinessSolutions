...
describe("[action] sol.contract.ix.actions.NegotiateContract", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.NegotiateContract", null, null).then(function success(objTempId) {
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("test finish negotiatecontract", function () {
    it("should throw if executed without 'user' and 'objId'", function (done) {
      expect(function () {
        test.Utils.execute("RF_sol_contract_action_NegotiateContract", {
    ...
    it("start action negotiate workflow", function (done) {
      expect(function () {
        configAction = {
          objId: objIdCr
        };
        test.Utils.execute("RF_sol_contract_action_NegotiateContract", configAction).then(function success(jsonResult) {
          done();
        }, function error(err) {
          fail(err);
          console.error(err);
