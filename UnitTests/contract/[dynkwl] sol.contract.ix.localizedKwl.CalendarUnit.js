...
describe("[dynkwl] sol.contract.ix.localizedKwl.CalendarUnit", function () {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.contract.ix.localizedKwl.CalendarUnit", function () {
      it("initialize", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_contract_service_ExecuteLib1", {
            className: "sol.contract.ix.localizedKwl.CalendarUnit",
            classConfig: {},
            method: "initialize",
            params: []
    ...
    describe("sol.contract.ix.localizedKwl.CalendarUnit", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_contract_service_ExecuteDynKwl", {
            objId: objCalendarUnitId,
            dynKwl: "sol.contract.ix.localizedKwl.CalendarUnit"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
