...
describe("[action] sol.contract.as.actions.CreateContractCoverSheet", function () {
  var objIdCr, contractTypes, succNodes, succNodesIds,
      params, targetId, templateId,
      configAction, contractCoversheetTypes, dvReport,
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("As.Actions.CreateContractCoverSheet", null, null).then(function success(objTempId) {
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("test create contractcoversheet from template", function () {
    ...
    it("start as action create contractcoversheet", function (done) {
      expect(function () {
        targetId = objIdCr;
        templateId = contractCoversheetTypes[0].objId;
