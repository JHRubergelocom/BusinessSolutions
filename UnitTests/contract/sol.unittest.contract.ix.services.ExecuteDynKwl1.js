...
//@include sol.contract.ix.dynkwl.Clauses.js
//@include sol.contract.ix.localizedKwl.PaymentDirection.js
//@include sol.contract.ix.localizedKwl.PaymentType.js

var logger = sol.create("sol.Logger", { scope: "sol.unittest.contract.ix.services.ExecuteDynKwl1" });
 ...
 *
 *
 *     sol.common.IxUtils.execute('RF_sol_unittest_contract_service_ExecuteDynKwl1', {
 *       objId: 5201,
 ...
 *
 */
sol.define("sol.unittest.contract.ix.services.ExecuteDynKwl1", {
...
/**
 * @member sol.unittest.contract.ix.services.ExecuteDynKwl1
 * @method RF_sol_unittest_contract_service_ExecuteDynKwl1
 * @static
 * @inheritdoc sol.unittest.ix.ServiceBase#RF_ServiceBaseName
 */
function RF_sol_unittest_contract_service_ExecuteDynKwl1(ec, args) {
  var params, service, result;
  logger.enter("RF_sol_unittest_contract_service_ExecuteDynKwl1", args);
  ...
  params.ec = ec;
  service = sol.create("sol.unittest.contract.ix.services.ExecuteDynKwl1", params);
  result = service.process();
  logger.exit("RF_sol_unittest_contract_service_ExecuteDynKwl1", result);
