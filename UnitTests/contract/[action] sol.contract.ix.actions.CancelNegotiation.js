...
describe("[action] sol.contract.ix.actions.CancelNegotiation", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.CancelNegotiation", null, null).then(function success(objTempId) {
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("test finish cancel negotiation", function () {
    ...
    it("start action cancelNegotiation workflow", function (done) {
      expect(function () {
        configAction = {
          objId: objIdCr
        };
