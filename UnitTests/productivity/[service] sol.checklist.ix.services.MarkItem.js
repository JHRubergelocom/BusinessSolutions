...
describe("[service] sol.checklist.ix.services.MarkItem", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Services.MarkItem", null, null).then(function success(objTempId1) {
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_checklist_service_MarkItem", function () {
      ...
      it("should throw if executed without 'objId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_checklist_service_MarkItem", {
          }).then(function success(result) {
            fail(result);
            done();
          }, function error(err) {
      ...
      it("should not throw if executed without 'mark'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_checklist_service_MarkItem", {
            objId: objCL,
            itemId: 1
            ...
            expect(result.status).toEqual("FAILURE");
            expect(result.error).toEqual("checklist.missing.mark");
            done();
          }, function error(err) {
            fail(err);
            console.error(err);
      ...
      it("test markitem", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_checklist_service_MarkItem", {
            objId: objCL,
            itemId: 1,
            ...
            expect(result.item.marked).toEqual(true);
      ...
      it("test readchecklist", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_checklist_service_ReadChecklist", {
            ...
            expect(result.items[0].marked).toEqual(true);
      ...
      it("test mark again", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_checklist_service_MarkItem", {
            objId: objCL,
            itemId: 1,
      ...
      it("test unmarkitem", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_checklist_service_MarkItem", {
            objId: objCL,
            itemId: 1,
      ...
      it("test unmark again", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_checklist_service_MarkItem", {
            objId: objCL,
            itemId: 1,
