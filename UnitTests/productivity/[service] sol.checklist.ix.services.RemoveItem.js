...
describe("[service] sol.checklist.ix.services.RemoveItem", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Services.RemoveItem", null, null).then(function success(objTempId1) {
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_checklist_service_RemoveItem", function () {
      ...
      it("should throw if executed without 'objId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_checklist_service_RemoveItem", {
          }).then(function success(result) {
            fail(result);
            done();
          }, function error(err) {
      ...
      it("test removeitem", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_checklist_service_RemoveItem", {
            objId: objCL,
            itemId: 1
