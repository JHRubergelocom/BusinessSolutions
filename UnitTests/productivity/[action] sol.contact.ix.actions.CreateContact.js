...
describe("[action] sol.contact.ix.actions.CreateContact", function () {
  var objTempId,
      ...
      refValueCL, refValueCo, originalTimeout, config, objId;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.contact.ix.actions.CreateContact", function () {
      it("getName", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_productivity_service_ExecuteLib1", {
            className: "sol.contact.ix.actions.CreateContact",
            classConfig: {},
            method: "getName",
            params: []
