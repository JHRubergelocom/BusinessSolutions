...
describe("[service] sol.checklist.ix.services.ReadChecklist", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Services.ReadChecklist", null, null).then(function success(objTempId1) {
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_checklist_service_ReadChecklist", function () {
      ...
      it("test readchecklist", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_checklist_service_ReadChecklist", {
            ...
            expect(result.items[1].text).toEqual("text2");
            expect(result.items[1].notes).toEqual("notes2");
