...
describe("[dynkwl] sol.online.ecm.ix.dynkwls.RestIteratorCashDiscount", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("RestIteratorCashDiscount").then(function success(objTempId) {
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.online.ecm.dynkwl.RestIteratorCashDiscount", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_datev_accounting_service_ExecuteDynKwl", {
            objId: objRDId,
            dynKwl: "sol.online.ecm.dynkwl.RestIteratorCashDiscount"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
