...
describe("[dynkwl] sol.online.ecm.ix.dynkwls.RestIteratorLedgerAccount", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("RestIteratorLedgerAccount").then(function success(objTempId) {
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.online.ecm.dynkwl.RestIteratorLedgerAccount", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_datev_accounting_service_ExecuteDynKwl", {
            objId: objRDId,
            dynKwl: "sol.online.ecm.dynkwl.RestIteratorLedgerAccount"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
