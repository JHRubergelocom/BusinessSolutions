...
describe("[dynkwl] sol.online.ecm.ix.dynkwls.RestIteratorCostCenters2", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("RestIteratorCostCenters2").then(function success(objTempId) {
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.online.ecm.dynkwl.RestIteratorCostCenters2", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_datev_accounting_service_ExecuteDynKwl", {
            objId: objRDId,
            dynKwl: "sol.online.ecm.dynkwl.RestIteratorCostCenters2"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
