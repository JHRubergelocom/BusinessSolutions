...
describe("[dynkwl] sol.datev.accounting.ix.dynkwls.RestIteratorWLCodes", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("RestIteratorWLCodes").then(function success(objTempId) {
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.datev.accounting.dynkwl.RestIteratorWLCodes", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_datev_accounting_service_ExecuteDynKwl", {
            objId: objRDId,
            dynKwl: "sol.datev.accounting.dynkwl.RestIteratorWLCodes"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
