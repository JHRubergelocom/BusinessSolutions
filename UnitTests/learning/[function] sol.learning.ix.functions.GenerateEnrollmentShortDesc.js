  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("GenerateEnrollmentShortDesc").then(function success(objGenerateEnrollmentShortDescId) {
        test.Utils.getSord("ARCPATH[(E10E1000-E100-E100-E100-E10E10E10E00)]:/Business Solutions/learning [unit tests]/Test data/Enrollment").then(function success2(sordEnrollment1) {
