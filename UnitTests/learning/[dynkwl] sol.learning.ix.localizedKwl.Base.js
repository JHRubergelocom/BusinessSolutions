...
describe("[dynkwl] sol.learning.ix.localizedKwl.Base", function () {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.learning.ix.localizedKwl.Base", function () {
      it("initialize", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_learning_service_ExecuteLib1", {
            className: "sol.learning.ix.localizedKwl.Base",
            classConfig: {},
            method: "initialize",
            params: []
  ...
  describe("Tests Dynamic Keyword lists", function () {
    describe("sol.learning.ix.dynkwl.Base", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_learning_service_ExecuteDynKwl1", {
            objId: objBaseId,
            dynKwl: "sol.learning.ix.localizedKwl.Base"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
