...
describe("[function] sol.learning.ix.functions.Reputation", function () {
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_learning_function_Reputation", function () {
      it("should throw if executed without 'objId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_learning_function_Reputation", {
    ...
    describe("RF_sol_learning_function_Reputation countdown", function () {
      it("should throw if executed without 'objId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_learning_function_Reputation", {
            countDown: true
