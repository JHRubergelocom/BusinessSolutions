...
describe("[action] sol.learning.ix.actions.CreateCourse", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.CreateCourse", null, null).then(function success(objTempId1) {
  ...
  describe("test finish createcourse", function () {
