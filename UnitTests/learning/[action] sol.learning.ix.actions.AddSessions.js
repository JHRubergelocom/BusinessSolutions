...
describe("[action] sol.learning.ix.actions.AddSessions", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.AddSessions", null, null).then(function success(objTempId1) {
        interval = 4000;
  ...
  describe("test add session", function () {
    ...
    describe("test finish addsessions", function () {
