...
describe("[service] sol.knowledge.ix.services.EditPost", function () {
  var objTempId, objSpaceId, objPostId, objFile1Id, objFile2Id, objFile3Id, objFile4Id,
      originalTimeout, objPostTId, params, post;

  beforeAll(function (done) {
    originalTimeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
    expect(function () {
      test.Utils.createTempSord("EditPost", null, null, elo.CONST.EDIT_INFO.mbSordDoc).then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.knowledge.ix.services.EditPost", function () {
      ...
      it("editPost", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_knowledge_service_ExecuteLib1", {
            className: "sol.knowledge.ix.services.EditPost",
            classConfig: { objId: objPostTId, content: "ContentT" },
            method: "editPost",
            params: []
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_knowledge_service_Post_Edit", function () {
      ...
      describe("edit post", function () {
        ...
        it("edit post with topics, content, createdFiles and lang", function (done) {
          expect(function () {
            test.Utils.execute("RF_sol_knowledge_service_Post_Edit", {
              objId: objPostId,
              content: "Content2",
