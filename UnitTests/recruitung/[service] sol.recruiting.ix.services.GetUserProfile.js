...
describe("[service] sol.recruiting.ix.services.GetUserProfile", function () {
  var originalTimeout;
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("GetUserProfile").then(function success(objTempId) {
        done();
      }, function error(err) {
        fail(err);
        console.error(err);
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_recruiting_service_GetUserProfile", function () {
      ...
      it("get user profile with parameter 'email'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_recruiting_service_GetUserProfile", {
