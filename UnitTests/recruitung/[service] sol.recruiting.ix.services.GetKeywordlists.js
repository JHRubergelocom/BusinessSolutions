...
describe("[service] sol.recruiting.ix.services.GetKeywordlists", function () {
  var originalTimeout,
      localizedKwls, language, cache, kwlName, kwl;
  ...
  describe("Test Lib Functions", function () {
    describe("sol.recruiting.ix.services.GetKeywordlists", function () {
      it("addKwlToCache", function (done) {
        expect(function () {
          ...
          test.Utils.execute("RF_sol_unittest_recruiting_service_ExecuteLib1", {
            className: "sol.recruiting.ix.services.GetKeywordlists",
            classConfig: {},
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_recruiting_service_GetKeywordlists", function () {
      it("get keywordlists (default: 'en')", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_recruiting_service_GetKeywordlists", {
          }).then(function success(jsonResult) {
