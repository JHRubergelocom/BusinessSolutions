...
describe("[service] sol.recruiting.ix.services.UpdateCandidate", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("UpdateCandidate").then(function success(objTempId1) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.recruiting.ix.services.UpdateCandidate", function () {
      it("addMappingToSord", function (done) {
        expect(function () {
          ...
          test.Utils.execute("RF_sol_unittest_recruiting_service_ExecuteLib1", {
            className: "sol.recruiting.ix.services.UpdateCandidate",
            classConfig: {},
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_recruiting_service_UpdateCandidate", function () {
      it("should throw if executed without Parameter ", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_recruiting_service_UpdateCandidate", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
