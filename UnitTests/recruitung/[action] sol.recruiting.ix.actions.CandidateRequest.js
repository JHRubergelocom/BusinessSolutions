...
describe("[action] sol.recruiting.ix.actions.CandidateRequest", function () {
  var objTempId, candidateTypes,
      configTypes, configAction, wfInfo, succNodes, succNodesIds, objIdC1, objIdC2,
      privateEmail, objIdR, requisitionTypes, requestTypes,
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.CandidateRequest", null, null).then(function success(objTempId1) {
  ...
  describe("test candidate request", function () {
    ...
    describe("test finish candidaterequest", function () {
      it("requestTypes must be available", function (done) {
        configTypes = {
          $types: {
            path: "ARCPATH[(E10E1000-E100-E100-E100-E10E10E10E00)]:/Business Solutions/recruiting/Configuration/Communication Templates/Request"
          },
          shortenDesc: true,
          maxDescLength: 1
        };
        test.Utils.execute("RF_sol_common_service_StandardTypes", configTypes).then(function success(requestTypes1) {
      ...
      it("start action candidate request workflow", function (done) {
        expect(function () {
          configAction = {
            ...
            $wf: {
              template: {
                name: "sol.recruiting.Candidate.Request"
              },
              name: "sol.recruiting.candidate.workflow.candidaterequest.message"
            },
            $events: [
              {
                id: "DIALOG"
              },
              {
                id: "FEEDBACK",
                onWfStatus: "SENT",
                message: "sol.recruiting.candidate.workflow.candidaterequest.feedback"
              }
            ],
            $new: {
              target: {
              ...
              name: "Request",
              template: {
                base: "ARCPATH[(E10E1000-E100-E100-E100-E10E10E10E00)]:/Business Solutions/recruiting/Configuration/Communication Templates/Request",
                name: requestTypes[0].name
              }
            },
            $permissions: {
              mode: "SET",
    ...
    describe("test cancel candidaterequest", function () {
      it("requestTypes must be available", function (done) {
        configTypes = {
          $types: {
            path: "ARCPATH[(E10E1000-E100-E100-E100-E10E10E10E00)]:/Business Solutions/recruiting/Configuration/Communication Templates/Request"
