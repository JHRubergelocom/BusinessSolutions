...
describe("[function] sol.recruiting.ix.functions.GenerateCandidateNo", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("GenerateCandidateNo").then(function success(objGenerateCandidateNoId) {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.recruiting.ix.functions.generators.GenerateCandidateNo", function () {
      it("getIdentifier", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_recruiting_service_ExecuteLib1", {
            className: "sol.recruiting.ix.functions.generators.GenerateCandidateNo",
            classConfig: {},
  ...
  describe("Tests Registered Functions", function () {
    describe("RF_sol_recruiting_function_generateCandidateNo", function () {
      it("should throw if executed without 'objId'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_recruiting_function_generateCandidateNo", {
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
      ...
      it("generate candidate no", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_recruiting_function_generateCandidateNo", {
