  ...
  describe("test rate candidate", function () {
    ...
    describe("test finish ratecandidate", function () {
      ...
      it("Prepare Rating", function (done) {
        expect(function () {
          test.Utils.updateWfMapData(wfInfo.flowId, objIdC1, { RATING_QUESTION1: "Administrator", USER1: "Administrator", USER_ID1: "1" }).then(function success(updateMapDataResult) {
            done();
          }, function error(err) {
            fail(err);
            console.error(err);
