...
describe("[action] sol.recruiting.ix.actions.PlanCandidateAppointment", function () {
  var objTempId, candidateTypes,
      configTypes, configAction, wfInfo, succNodes, succNodesIds, objIdC1, objIdC2,
      privateEmail, objIdR, requisitionTypes, appointmentTypes,
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.PlanCandidateAppointment", null, null).then(function success(objTempId1) {
  ...
  describe("test candidate appointment", function () {
    ...
    describe("test finish plancandidateappointment", function () {
      it("appointmentTypes must be available", function (done) {
        configTypes = {
          $types: {
            path: "ARCPATH[(E10E1000-E100-E100-E100-E10E10E10E00)]:/Business Solutions/recruiting/Configuration/Communication Templates/Appointment"
          },
          shortenDesc: true,
          maxDescLength: 1
        };
        test.Utils.execute("RF_sol_common_service_StandardTypes", configTypes).then(function success(appointmentTypes1) {
          appointmentTypes = appointmentTypes1;
      ...
      it("appointmentTypes.length must greater than zero", function () {
      ...
      it("start action candidate appointment workflow", function (done) {
        expect(function () {
          configAction = {
            $name: "PlanCandidateAppointment",
            objId: objIdC1,
            $metadata: {
            ...
            $wf: {
              template: {
                name: "sol.recruiting.Candidate.PlanAppointment"
              },
              name: "sol.recruiting.candidate.workflow.plancandidateappointment.message"
            },
            $events: [
              {
                id: "DIALOG"
              },
              {
                id: "FEEDBACK",
                onWfStatus: "SENT",
                message: "sol.recruiting.candidate.workflow.plancandidateappointment.feedback"
              }
            ],
            $new: {
              target: {
              ...
              template: {
                base: "ARCPATH[(E10E1000-E100-E100-E100-E10E10E10E00)]:/Business Solutions/recruiting/Configuration/Communication Templates/Appointment",
    ...
    describe("test cancel plancandidateappointment", function () {
      it("appointmentTypes must be available", function (done) {
        configTypes = {
          $types: {
            path: "ARCPATH[(E10E1000-E100-E100-E100-E10E10E10E00)]:/Business Solutions/recruiting/Configuration/Communication Templates/Appointment"
