...
describe("[dynkwl] sol.recruiting.ix.dynkwls.OrganizationalStructuresIterator", function () {
  ...
  describe("Test Lib Functions", function () {
    describe("sol.recruiting.ix.dynkwl.OrganizationalStructuresIterator", function () {
      it("getFindInfo", function (done) {
        filterList = [];
        expect(function () {
          test.Utils.execute("RF_sol_unittest_recruiting_service_ExecuteLib1", {
            className: "sol.recruiting.ix.dynkwl.OrganizationalStructuresIterator",
            classConfig: {},
            method: "getFindInfo",
            params: [filterList]
      ...
      it("getRowData", function (done) {
        expect(function () {
          sord = { id: objOrganizationalStructuresIteratorId };
          test.Utils.execute("RF_sol_unittest_recruiting_service_ExecuteLib1", {
            className: "sol.recruiting.ix.dynkwl.OrganizationalStructuresIterator",
            classConfig: {},
            method: "getRowData",
    ...
    describe("sol.recruiting.ix.dynkwl.OrganizationalStructuresIterator", function () {
      ...
      it("should throw if executed without 'providerConfig'", function (done) {
        expect(function () {
          test.Utils.execute("RF_sol_unittest_recruiting_service_ExecuteDynKwl", {
            objId: objOrganizationalStructuresIteratorId,
            dynKwl: "sol.recruiting.ix.dynkwl.OrganizationalStructuresIterator"
          }).then(function success(jsonResult) {
            fail(jsonResult);
            done();
          }, function error(err) {
