...
describe("[action] sol.recruiting.ix.actions.PublishPosting", function () {
  ...
  beforeAll(function (done) {
    ...
    expect(function () {
      test.Utils.createTempSord("Actions.PublishPosting", null, null).then(function success(objTempId1) {
  ...
  describe("test create posting", function () {
    ...
    describe("create posting1", function () {
    ...
    describe("create posting2", function () {
      it("postingTypes must be available", function (done) {
        configTypes = {
          $types: {
            path: "ARCPATH[(E10E1000-E100-E100-E100-E10E10E10E00)]:/Business Solutions/recruiting/Configuration/Posting types"
  ...
  describe("test finish publishposting", function () {
    it("start action create workflow", function (done) {
      expect(function () {
        configAction = {
          $name: "PublishPosting",
          ...
          $wf: {
            template: {
              name: "sol.recruiting.Posting.Publish"
            },
            name: "sol.recruiting.posting.workflow.publish.message"
          },
          $events: [
            {
              id: "DIALOG"
            ...
            {
              id: "FEEDBACK",
              onWfStatus: "UNAVAILABLE",
              message: "sol.recruiting.client.posting.publish.feedback.unavailable"
            }
          ]
        };
        wfInfo = {};
    ...
    it("remove workflows", function (done) {
      expect(function () {
        test.Utils.getFinishedWorkflows(objIdP1).then(function success(wfs) {
          test.Utils.removeFinishedWorkflows(wfs).then(function success1(removeFinishedWorkflowsResult) {
            done();
          }, function error(err) {
            fail(err);
  ...
  describe("test cancel publishposting", function () {
    it("start action create workflow", function (done) {
      expect(function () {
        configAction = {
          $name: "PublishPosting",
    ...
    it("remove workflows", function (done) {
      expect(function () {
        test.Utils.getFinishedWorkflows(objIdP2).then(function success(wfs) {
          test.Utils.removeFinishedWorkflows(wfs).then(function success1(removeFinishedWorkflowsResult) {
            done();
          }, function error(err) {
            fail(err);
      ...
      test.Utils.getTempfolder().then(function success(tempfolder) {
        test.Utils.deleteSord(tempfolder).then(function success1(deleteResult) {
          test.Utils.deleteSord(objIdP1).then(function success2(deleteResult1) {
            test.Utils.deleteSord(objIdP2).then(function success3(deleteResult2) {
