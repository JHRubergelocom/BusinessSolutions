...
sol.define("sol.teamroom.ix.functions.RegisterUser", {
  ...
  createRegistrationMessage: function (user) {
    ...
    objId = sol.common.IxUtils.execute("RF_sol_function_CreateSord", {
      sourceElement: { objId: me._config.registrationTemplate },
      targetFolder: { objId: "0" },
      onCreatedElement: { setName: user.name }
    }).objId;
