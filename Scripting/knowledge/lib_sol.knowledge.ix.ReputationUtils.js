...
/**
 * Knowledge reputation utilities
 *
 ...
 */
sol.define("sol.knowledge.ix.ReputationUtils", {
  singleton: true,

  /**
   * Loads (and merges) the reputation configuration from the JSON file: `/Administration/Business Solutions/knowledge/Configuration/reputation.config`
   * @return {Object}
   */
  loadConfig: function () {
    var me = this;

    me.config = sol.create("sol.common.Config", { compose: "/knowledge/Configuration/reputation.config" }).config;
