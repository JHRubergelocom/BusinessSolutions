...
var logger = sol.create("sol.Logger", { scope: "sol.knowledge.ix.functions.Reputation" });
/**
 ...
 * # As IX function call
 *
 *   sol.common.IxUtils.execute("RF_sol_knowledge_function_Reputation", {
 *     objId: 4713
 ...
 */
sol.define("sol.knowledge.ix.functions.Reputation", {
   ...
   *
   * If type "REPLY_CREATE" is given and extendType is set to index field "KNOWLEDGE_CONTENT_TYPE" the content type will be added to type (e.g. "REPLY_CREATE_ARTICLE").
   */
  ...
  process: function () {
    ...
    sol.knowledge.ix.ReputationUtils.grant(me.type, me.userId, me.countDown);
  }
});

/**
 * @member sol.knowledge.ix.functions.Reputation
 * @static
...
function onEnterNode(clInfo, userId, wFDiagram, nodeId) {
  ...
  grant = sol.create("sol.knowledge.ix.functions.Reputation", params);
  grant.process();
...
/**
 * @member sol.knowledge.ix.functions.Reputation
 * @method RF_sol_knowledge_function_Reputation
 * @static
 * @inheritdoc sol.common.ix.FunctionBase#RF_FunctionName
 */
function RF_sol_knowledge_function_Reputation(iXSEContext, args) {
  logger.enter("RF_sol_knowledge_function_Reputation", args);
  ...
  logger.exit("RF_sol_knowledge_function_Reputation");
}
