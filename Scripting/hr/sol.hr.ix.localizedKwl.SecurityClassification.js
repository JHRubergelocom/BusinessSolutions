...
/**
 * Localized keyword list for securityclassifications
 *
 ...
 */
sol.define("sol.hr.ix.localizedKwl.SecurityClassification", {
   ...
   */
  kwlName: "securityclassification",
...
/**
 * Implements a localized keyword list for securityclassification
 * @static
 * @member sol.hr.ix.localizedKwl.SecurityClassification
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.hr.ix.localizedKwl.SecurityClassification" }),
      iterator;
  try {
    log.info("LocalizedKeywordList (");
    iterator = sol.create("sol.hr.ix.localizedKwl.SecurityClassification", {});
