...
/**
 * Localized keyword list for firstlanguages
 *
 ...
 */
sol.define("sol.hr.ix.localizedKwl.FirstLanguage", {
...
/**
 * Implements a localized keyword list for firstlanguage
 * @static
 * @member sol.hr.ix.localizedKwl.FirstLanguage
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.hr.ix.localizedKwl.FirstLanguage" }),
      iterator;
  try {
    log.info("LocalizedKeywordList (");
    iterator = sol.create("sol.hr.ix.localizedKwl.FirstLanguage", {});
