...
/**
 * Localized keyword list for civil statuses
 *
 ...
 */
sol.define("sol.hr.ix.localizedKwl.CivilStatus", {
...
/**
 * Implements a localized keyword list for civilstatus
 * @static
 * @member sol.hr.ix.localizedKwl.CivilStatus
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.hr.ix.localizedKwl.CivilStatus" }),
      iterator;
  try {
    log.info("LocalizedKeywordList (");
    iterator = sol.create("sol.hr.ix.localizedKwl.CivilStatus", {});
