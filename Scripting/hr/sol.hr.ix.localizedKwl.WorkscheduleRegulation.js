...
/**
 * Localized keyword list for workscheduleregulations
 *
 ...
 */
sol.define("sol.hr.ix.localizedKwl.WorkscheduleRegulation", {
   ...
   */
  kwlName: "workscheduleregulation",
...
/**
 * Implements a localized keyword list for workscheduleregulation
 * @static
 * @member sol.hr.ix.localizedKwl.WorkscheduleRegulation
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.hr.ix.localizedKwl.WorkscheduleRegulation" }),
      iterator;
  try {
    log.info("LocalizedKeywordList (");
    iterator = sol.create("sol.hr.ix.localizedKwl.WorkscheduleRegulation", {});
