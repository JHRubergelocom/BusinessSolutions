...
sol.define("sol.hr.ix.actions.CreateEmployeeRequest", {
  ...
  inject: {
    //configproperties
    inheritanceActiveForSoltypes: { config: "hr", prop: "entities.request.actions.create.options.api.enable.soltypes", template: true }, // []
    shortDescription: { config: "hr", prop: "entities.request.actions.create.const.temporaryAttributes.shortDescription", template: true }, // ""
    target: { config: "hr", prop: "entities.request.actions.create.const.temporaryAttributes.targetDirectory", template: true }, // ""
    standardWfField: { config: "hr", prop: "entities.request.actions.create.workflow.maskStandardWorkflow.field", template: true }, // ""
    useStandardWf: { config: "hr", prop: "entities.request.actions.create.workflow.maskStandardWorkflow.start" }, // bool
    customWf: { config: "hr", prop: "entities.request.actions.create.workflow.customWorkflow.name", template: true }, // ""
    dialogTitle: { config: "hr", prop: "entities.request.actions.create.workflow.dialogTitle", template: true }, // ""
    addReferences: { config: "hr", prop: "entities.request.actions.create.options.addReferences", template: true, log: false }, // []
    rights: { config: "hr", prop: "entities.request.actions.create.options.changeRights", template: true }, // {}
    standardTargetMaskName: { config: "hr", prop: "entities.request.actions.create.const.standardTargetMaskName", template: true }, // ""
    standardTargetSordTypeName: { config: "hr", prop: "entities.request.actions.create.const.standardTargetSordTypeName", template: true }, // ""
  ...
  initialize: function (params) {
    ...
    me.params = params;
    me.personnelfile = params.typeInheritanceGuid && sol.hr.shared.Utils.getSordData(params.typeInheritanceGuid, undefined, true);  // can't use direct sordid-inject because admin access is required
  },
...
/**
 * @member sol.hr.ix.actions.CreateEmployeeRequest
 * @method RF_sol_hr_personnel_action_CreateEmployeeRequest
 * @static
 * @inheritdoc sol.common.ix.ActionBase#RF_FunctionName
 */
function RF_sol_hr_personnel_action_CreateEmployeeRequest(ec, args) {
  var rfParams, actionProc, result;

  rfParams = sol.common.ix.RfUtils.parseAndCheckParams(ec, arguments.callee.name, args);

  actionProc = sol.create("sol.hr.ix.actions.CreateEmployeeRequest", rfParams);
