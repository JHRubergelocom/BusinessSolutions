...
sol.define("sol.hr.ix.services.GetOffboardingTypes", {
  ...
  process: function () {
    ...
    result.valid = (sol.common.ObjectUtils.getProp(sol.hr.shared.Utils.getSordData(me.targetId), me.employeeTerminatedStatus.key)).indexOf(me.employeeTerminatedStatus.value.trim()) !== 0;
    if (!result.valid) {
