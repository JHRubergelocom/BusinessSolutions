...
/**
 * dynamic keyword list for personnel file short description generator
 *
 ...
 */
sol.define("sol.hr.ix.dynkwl.generators.FileShortDesc", {
  extend: "sol.common.ix.DynKwlFindChildrenIterator",
  
  mixins: ["sol.hr.mixins.Configuration", "sol.common.mixins.Inject"],
  
  inject: {
    kwl: { config: "hr", prop: "entities.file.functions.generatefileshortdescription", template: true } // {}
  },
 ...
 * @static
 * @member sol.hr.ix.dynkwl.generators.FileShortDesc
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var className = "sol.hr.ix.dynkwl.generators.FileShortDesc",
