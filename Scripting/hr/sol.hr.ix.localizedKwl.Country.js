 ...
 */
sol.define("sol.hr.ix.localizedKwl.Country", {
...
/**
 * Implements a localized keyword list for country
 * @static
 * @member sol.hr.ix.localizedKwl.Country
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.hr.ix.localizedKwl.Country" }),
      iterator;
  try {
    log.info("LocalizedKeywordList (");
    iterator = sol.create("sol.hr.ix.localizedKwl.Country", {});
