...
/**
 * Localized keyword list for terminationpoints
 *
 ...
 */
sol.define("sol.hr.ix.localizedKwl.TerminationPoint", {
...
/**
 * Implements a localized keyword list for terminationpoint
 * @static
 * @member sol.hr.ix.localizedKwl.TerminationPoint
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.hr.ix.localizedKwl.TerminationPoint" }),
      iterator;
  try {
    log.info("LocalizedKeywordList (");
    iterator = sol.create("sol.hr.ix.localizedKwl.TerminationPoint", {});
