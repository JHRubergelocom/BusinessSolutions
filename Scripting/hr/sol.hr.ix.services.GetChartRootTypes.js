 ...
 */
sol.define("sol.hr.ix.services.GetChartRootTypes", {
  extend: "sol.common.ix.ServiceBase",
  
  mixins: ["sol.hrorgchart.mixins.Configuration", "sol.common.mixins.Inject"],
  
  inject: {
    contextTypes: { config: "hrorgchart", prop: "entities.chartelement.services.chartroottypes.contextTypes", template: true } // {}
  },
  ...
  process: function () {
    ...
    if (selectedId) {
      ...
      if (!result.valid) {
        result.msg = sol.hr.shared.Utils.translate("sol.hr.orgchart.createchartroot.notpossible");
      }
    }
...
/**
 * @member sol.hr.ix.services.GetChartRootTypes
 * @method RF_sol_common_service_GetChartRootTypes
 * @static
 * @inheritdoc sol.common.ix.ServiceBase#RF_ServiceBaseName
 */
function RF_sol_hr_service_GetChartRootTypes(iXSEContext, args) {
  ...
  serviceProc = sol.create("sol.hr.ix.services.GetChartRootTypes", rfParams);
