 ...
 */
sol.define("sol.hr.ix.dynkwl.MentorIterator", {
  extend: "sol.hr.ix.dynkwl.PersonnelFileIterator",

  mixins: ["sol.hr.mixins.Configuration"],

  inject: {
    dynkwl: { config: "hr", prop: "entities.file.dynkwls.mentor", template: true }, // {}
 ...
 * @static
 * @member sol.hr.ix.dynkwl.MentorIterator
 * @return {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.hr.ix.dynkwl.MentorIterator" }),
      iterator;
  try {
    log.info("DynamicKeywordList (");
    iterator = sol.create("sol.hr.ix.dynkwl.MentorIterator", {});
