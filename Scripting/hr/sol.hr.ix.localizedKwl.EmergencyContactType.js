...
/**
 * Localized keyword list for ermergency contact type
 *
 ...
 */
sol.define("sol.hr.ix.localizedKwl.EmergencyContactType", {
...
/**
 * Implements a localized keyword list for EmergencyContactType
 * @static
 * @member sol.hr.ix.localizedKwl.EmergencyContactType
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.hr.ix.localizedKwl.EmergencyContactType" }),
      iterator;
  try {
    log.info("LocalizedKeywordList (");
    iterator = sol.create("sol.hr.ix.localizedKwl.EmergencyContactType", {});
