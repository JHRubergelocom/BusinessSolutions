...
var logger = sol.create("sol.Logger", { scope: "sol.learning.ix.functions.generators.GenCommShortDesc" });
 ...
 */
sol.define("sol.learning.ix.functions.generators.GenCommShortDesc", {
  ...
  inject: {
    templateField: { config: "learning", prop: "entities.communication.functions.generatecommunicationshortdescription.generatorConfig.generatorTemplateField", template: true }, // ""
    templateFolder: { config: "learning", prop: "entities.communication.functions.generatecommunicationshortdescription.generatorConfig.templatesFolder", template: true } // ""
  },
  ...
  getIdentifierTemplateId: function () {
    var me = this;
    return me.getTemplateId("Communication short description", me.templateField, me.templateFolder);
  },
...
function onEnterNode(_clInfo, _userId, wFDiagram, nodeId) {
  ...
  genProc = sol.create("sol.learning.ix.functions.generators.GenCommShortDesc", params);
 ...
 * @method RF_sol_learning_function_generateCommShortDesc
 * @static
 * @inheritdoc sol.common.ix.FunctionBase#RF_FunctionName
 */
function RF_sol_learning_function_generateCommShortDesc(iXSEContext, args) {
  logger.enter("RF_sol_learning_function_generateCommShortDesc", args);
  var params = sol.common.ix.RfUtils.parseAndCheckParams(iXSEContext, arguments.callee.name, args, "objId"),
      genProc = sol.create("sol.learning.ix.functions.generators.GenCommShortDesc", params),
      result;
  result = genProc.process();
  logger.exit("RF_sol_learning_function_generateCommShortDesc");
  return result;
}
