...
var logger = sol.create("sol.Logger", { scope: "sol.learning.ix.functions.generators.GenEnrollmentShortDesc" });
 ...
 */
sol.define("sol.learning.ix.functions.generators.GenEnrollmentShortDesc", {
  ...
  inject: {
    templateField: { config: "learning", prop: "entities.enrollment.functions.generateenrollmentshortdescription.generatorConfig.generatorTemplateField", template: true }, // ""
    templateFolder: { config: "learning", prop: "entities.enrollment.functions.generateenrollmentshortdescription.generatorConfig.templatesFolder", template: true } // ""
  },
  ...
  getIdentifierTemplateId: function () {
    var me = this;
    return me.getTemplateId("Enrollment short description", me.templateField, me.templateFolder);
  },
...
function onEnterNode(_clInfo, _userId, wFDiagram, nodeId) {
  ...
  genProc = sol.create("sol.learning.ix.functions.generators.GenEnrollmentShortDesc", params);
 ...
 * @method RF_sol_learning_function_generateEnrollmentShortDesc
 * @static
 * @inheritdoc sol.common.ix.FunctionBase#RF_FunctionName
 */
function RF_sol_learning_function_generateEnrollmentShortDesc(iXSEContext, args) {
  logger.enter("RF_sol_common_function_generateEnrollmentReference", args);
  var params = sol.common.ix.RfUtils.parseAndCheckParams(iXSEContext, arguments.callee.name, args, "objId"),
      genProc = sol.create("sol.learning.ix.functions.generators.GenEnrollmentShortDesc", params),
      result;
  result = genProc.process();
  logger.exit("RF_sol_learning_function_generateEnrollmentShortDesc");
  return result;
}
