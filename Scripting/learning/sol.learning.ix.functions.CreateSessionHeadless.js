...
sol.define("sol.learning.ix.functions.CreateSessionHeadless", {
  ...
  inject: {
    ...
    _templateServiceArgs: { config: "learning", prop: "entities.session.actions.createheadless.const.templateServiceArgs" }, // ""
  ...
  getTemplateObjIdByName: function (templateName) {
    ...
    template = sol.common.ObjectUtils.getProp(me.getTemplates(me._templateService, me._templateServiceArgs), templateName, "name");
