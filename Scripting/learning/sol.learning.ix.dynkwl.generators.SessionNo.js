...
/**
 * dynamic keyword list for session no. generator
 *
 ...
 */
sol.define("sol.learning.ix.dynkwl.generators.SessionNo", {
  extend: "sol.learning.ix.dynKwl.generators.Base",
  kwlPath: "entities.session.functions.generatesessionno"
});

/**
 * Implements a dynamic keyword list for session no. generator
 * @static
 * @member sol.learning.ix.dynkwl.generators.SessionNo
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var className = "sol.learning.ix.dynkwl.generators.SessionNo",
