...
var logger = sol.create("sol.Logger", { scope: "sol.learning.ix.functions.generators.GenerateSessionNo" });
 ...
 */
sol.define("sol.learning.ix.functions.generators.GenerateSessionNo", {
  ...
  inject: {
    templateField: { config: "learning", prop: "entities.session.functions.generatesessionno.generatorConfig.generatorTemplateField", template: true }, // ""
    templateFolder: { config: "learning", prop: "entities.session.functions.generatesessionno.generatorConfig.templatesFolder", template: true }, // ""
    targetField: { config: "learning", prop: "entities.session.functions.generatesessionno.generatorConfig.targetField", template: true } // ""
  },
  ...
  getIdentifierTemplateId: function () {
    var me = this;
    return me.getTemplateId("Session no.", me.templateField, me.templateFolder);
  },
  ...
  getIdentifier: function () {
    var me = this;
    if (!me.targetField) {
      throw "getIdentifier(): Session No. field name must not be empty.";
    }
  ...
  setIdentifier: function (No) {
    var me = this;
    if (!me.targetField) {
      throw "setIdentifier(): Session No. field name must not be empty.";
    }
...
function onEnterNode(clInfo, userId, wFDiagram, nodeId) {
  ...
  genProc = sol.create("sol.learning.ix.functions.generators.GenerateSessionNo", params);
 ...
 * @method RF_sol_learning_function_generateSessionNo
 * @static
 * @inheritdoc sol.common.ix.FunctionBase#RF_FunctionName
 */
function RF_sol_learning_function_generateSessionNo(iXSEContext, args) {
  ...
  logger.exit("RF_sol_learning_function_generateSessionNo");
  return result;
}
