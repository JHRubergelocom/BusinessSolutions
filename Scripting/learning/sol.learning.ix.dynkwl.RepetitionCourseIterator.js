...
/**
 * Dynamic keyword list that returns the sord content of Courses for course repetition selected by solution object type.
 *
 ...
 * @requires sol.learning.ix.dynkwl.BaseCourseIterator
 */
sol.define("sol.learning.ix.dynkwl.RepetitionCourseIterator", {
  extend: "sol.learning.ix.dynkwl.BaseCourseIterator",
  ...
  inject: {
    ...
    tableKeyNames: { config: "learning", prop: "entities.course.dynkwls.repetitionCourse.tableKeyNames", template: true },
 ...
 * @static
 * @member sol.learning.ix.dynkwl.RepetitionCourseIterator
 * @return {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.learning.ix.dynkwl.RepetitionCourseIterator" }),
      iterator;
  try {
    log.info("DynamicKeywordList (");
    iterator = sol.create("sol.learning.ix.dynkwl.RepetitionCourseIterator", { focusFieldGivesValueForMap: true });
