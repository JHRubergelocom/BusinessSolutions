...
sol.define("sol.common_monitoring.ix.functions.UpdateTimedEvent", {
  ...
  messages: {
    missingTimedEent: "Could not determine timed event to upate",
    missingSource: "Could not determine source of timed event to update",
    missingConfig: "Could not determine config of timed event to update",
    missingRequest: "Could not create request",
    success: "update timed event executed"
  },
  ...
  getUpdateRequest: function (params) {
    ...
    template.entries = me.getUpdateRequestEntries(params).map(me.mapUpdateRequestEntries.bind(me, params));
...
/**
* @member sol.common_monitoring.ix.functions.UpdateTimedEvent
* @method RF_sol_common_monitoring_ix_service_UpdateTimedEvent
* @static
* @inheritdoc sol.common.ix.FunctionBase#RF_FunctionName
*/
function RF_sol_common_monitoring_ix_service_UpdateTimedEvent(iXSEContext, args) {
  var rfArgs, fun;
