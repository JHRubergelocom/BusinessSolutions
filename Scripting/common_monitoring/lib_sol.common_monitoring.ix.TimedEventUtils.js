...
sol.define("sol.common_monitoring.ix.TimedEventUtils", {
  ...
  renderRequestParams: function (requestParams, params, isRerender) {
    ...
    return isRerender
      ? renderedParams
      : sol.common_monitoring.ix.TimedEventUtils.renderRequestParams(renderedParams, params, true);
  },
