...
/**
 * Localized keyword list for contract termination points.
 *
 ...
 */
sol.define("sol.contract.ix.localizedKwl.TerminationPoint", {
 ...
 * @static
 * @member sol.contract.ix.localizedKwl.TerminationPoint
 * @return {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.contract.ix.localizedKwl.TerminationPoint" }),
      iterator;
  try {
    log.info("LocalizedKeywordList (");
    iterator = sol.create("sol.contract.ix.localizedKwl.TerminationPoint", {});
