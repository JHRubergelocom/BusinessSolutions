...
sol.define("sol.contract.ix.functions.ExtendDuration", {
  ...
  process: function () {
    ...
    sol.contract.DurationUtils.extendContract(tplSord, updates);
  ...
  calcPaymentPlan: function () {
    ...
    sol.common.SordUtils.setObjKeyValue(me.sord, me.contractConfig.fields.cashflowSum, total);
    ...
    sol.common.SordUtils.setObjKeyValue(me.sord, me.contractConfig.fields.cashflowSumLocalCurr, amountLocalCurr);
  }
});
