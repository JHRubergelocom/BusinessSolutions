 ...
 */
sol.define("sol.contract.ix.localizedKwl.ReasonEnd", {
 ...
 * @static
 * @member sol.contract.ix.localizedKwl.ReasonEnd
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.contract.ix.localizedKwl.ReasonEnd" }),
      iterator;
  try {
    log.info("LocalizedKeywordList (");
    iterator = sol.create("sol.contract.ix.localizedKwl.ReasonEnd", {});
