 ...
 */
sol.define("sol.contract.ix.localizedKwl.CalendarUnit", {
 ...
 * @static
 * @member sol.contract.ix.localizedKwl.CalendarUnit
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.contract.ix.localizedKwl.CalendarUnit" }),
      iterator;
  try {
    log.info("LocalizedKeywordList (");
    iterator = sol.create("sol.contract.ix.localizedKwl.CalendarUnit", {});
