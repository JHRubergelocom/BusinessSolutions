...
/**
 * Localized keyword list for contract cashflow recurrance
 *
 ...
 */
sol.define("sol.contract.ix.localizedKwl.CashflowRecurring", {
 ...
 * @static
 * @member sol.contract.ix.localizedKwl.CashflowRecurring
 * @return {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.contract.ix.localizedKwl.CashflowRecurring" }),
      iterator;
  try {
    log.info("LocalizedKeywordList (");
    iterator = sol.create("sol.contract.ix.localizedKwl.CashflowRecurring", {});
