...
/**
 * Localized keyword list for contract relations
 *
 ...
 * @static
 * @member sol.contract.ix.localizedKwl.Relation
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.contract.ix.localizedKwl.Relation" }),
      iterator;
  try {
    log.info("LocalizedKeywordList (");
    iterator = sol.create("sol.contract.ix.localizedKwl.Relation", {});
