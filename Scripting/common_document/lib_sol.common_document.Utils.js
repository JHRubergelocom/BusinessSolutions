...
sol.define("sol.common_document.Utils", {
  ...
  createCoverSheetSord: function (sord, dstDirPath) {
    var generator, templateId, result, targetId;

    templateId = "ARCPATH[(E10E1000-E100-E100-E100-E10E10E10E00)]:/Business Solutions/common_document/Configuration/Coversheet Templates/Default";
    targetId = "ARCPATH:/_Temp";

    generator = sol.create("sol.common.as.DocumentGenerator", {
      name: "Deckblatt " + sord.name,
