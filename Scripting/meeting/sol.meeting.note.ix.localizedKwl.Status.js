...
/**
 * Localized keyword list for meeting note status
 *
 ...
 *
 */
sol.define("sol.meeting.note.ix.localizedKwl.Status", {
...
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.meeting.note.ix.localizedKwl.Status" }),
      iterator;

  try {
    log.info("LocalizedKeywordList (");

    iterator = sol.create("sol.meeting.note.ix.localizedKwl.Status", {});
