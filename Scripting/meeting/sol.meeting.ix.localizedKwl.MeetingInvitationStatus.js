...
/**
 * Localized keyword list for meeting invitation status.
 *
 ...
 */
sol.define("sol.meeting.ix.localizedKwl.MeetingInvitationStatus", {
   ...
   */
  kwlName: "meetingInvitationStatus",
 ...
 * @static
 * @member sol.meeting.ix.localizedKwl.MeetingInvitationStatus
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.meeting.ix.localizedKwl.MeetingInvitationStatus" }),
      iterator;

  try {
    log.info("LocalizedKeywordList (");

    iterator = sol.create("sol.meeting.ix.localizedKwl.MeetingInvitationStatus", {});
