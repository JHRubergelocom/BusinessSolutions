...
/**
 * Localized keyword list for meeting resolution status.
 *
 ...
 */
sol.define("sol.meeting.ix.localizedKwl.ResolutionStatus", {
...
function getDataIterator() {
    var log = sol.create("sol.Logger", { scope: "sol.meeting.ix.localizedKwl.ResolutionStatus" }),
        iterator;

    try {
        log.info("LocalizedKeywordList (");

        iterator = sol.create("sol.meeting.ix.localizedKwl.ResolutionStatus", {});
