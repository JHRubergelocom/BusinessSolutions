 ...
 */
sol.define("sol.meeting.voting.ix.localizedKwl.Implementation", {
 ...
 * @static
 * @member sol.meeting.ix.localizedKwl.Implementation
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.meeting.voting.ix.localizedKwl.Implementation" }),
      iterator;

  try {
    log.info("LocalizedKeywordList (");

    iterator = sol.create("sol.meeting.voting.ix.localizedKwl.Implementation", {});
