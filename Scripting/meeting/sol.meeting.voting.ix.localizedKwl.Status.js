 ...
 */
sol.define("sol.meeting.voting.ix.localizedKwl.Status", {
 ...
 * @static
 * @member sol.meeting.ix.localizedKwl.Status
 * @returns {DynamicKeywordDataProvider}
 */
function getDataIterator() {
  var log = sol.create("sol.Logger", { scope: "sol.meeting.voting.ix.localizedKwl.Status" }),
      iterator;

  try {
    log.info("LocalizedKeywordList (");

    iterator = sol.create("sol.meeting.voting.ix.localizedKwl.Status", {});
