 ...
 */
sol.define("sol.common.ix.services.GetUsers", {
...
/**
 * @member sol.common.ix.services.GetUsers
 * @method RF_sol_common_service_GetUsers
 * @static
 * @inheritdoc sol.common.ix.ServiceBase#RF_ServiceBaseName
 */
function RF_sol_common_service_GetUsers(iXSEContext, args) {
  var rfParams, result;

  rfParams = sol.common.ix.RfUtils.parseAndCheckParams(iXSEContext, arguments.callee.name, args);
  result = (sol.create("sol.common.ix.services.GetUsers", rfParams)).process();
