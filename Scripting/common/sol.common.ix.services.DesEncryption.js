...
var logger = sol.create("sol.Logger", { scope: "sol.common.ix.services.DesEncryption" });

/**
 * Encrypt and decryption strings
 *
 * # Example
 *
 ...
 * # Example
 *
 *     var result = sol.common.IxUtils.execute("RF_sol_common_services_Decrypt", {
 *       "text": "185-106-46-93-233-36-251-195-206-98-247-59-215-247-166-116-83-51-36-94-29-49-2-148"
 *     });
 *
 * # Result
 *
 ...
 */
sol.define("sol.common.ix.services.DesEncryption", {
  extend: "sol.common.ix.ServiceBase",

  requiredConfig: ["text"],

  /**
   * @cfg {String} text text to encrypt/decrypt.
   */
...
/**
 * @member sol.common.ix.services.DesEncryption
...
function RF_sol_common_services_Encrypt(ec, args) {
  ...
  params.ec = ec;
  service = sol.create("sol.common.ix.services.DesEncryption", params);
...
/**
 * @member sol.common.ix.services.DesEncryption
 * @method RF_sol_common_services_Decrypt
 * @static
 * @inheritdoc sol.common.ix.ServiceBase#RF_ServiceBaseName
 */
function RF_sol_common_services_Decrypt(ec, args) {
  var params, service, result;

  logger.enter("RF_sol_common_services_Decrypt", args);

  params = sol.common.ix.RfUtils.parseAndCheckParams(ec, arguments.callee.name, args, "text");
  params.ec = ec;
  service = sol.create("sol.common.ix.services.DesEncryption", params);
  result = service.decrypt();
  logger.exit("RF_sol_common_services_Decrypt", result);
  return sol.common.JsonUtils.stringifyAll(result);
}
