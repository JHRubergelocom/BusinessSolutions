...
sol.define("sol.dev.jc.GotoId", {
   ...
   execute: function () {
      var mode = 1,
         ...
         result, isObjId, isDocId, searchId, memoText, translate, intId, editInfo, me = this;
   ...
   inputIdDlg: function (lastId, mode) {
      ...
      if (workspace.activeView && workspace.activeView.firstSelected) {
         ...
         var txtObjid = panel.addTextField(3, nextLine, 7);
